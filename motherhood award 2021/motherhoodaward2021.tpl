...
<span class="navigation-pipe">{$navigationPipe}</span>
	{l s='Motherhood award 2021'  mod='enlineamixmod'}
{/capture}
...
<!-- MODULE motherhood award 2021 -->

<div class="container-fluid no-padding">
	<section class="hero-banner">
		<div class="row">
			<div class="col-md-12">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Motherhood+Choice+Awards+2021/Secondpage/banner-2ndpage.png" alt="placeholder 960" class="img-responsive" />
			</div>
		</div>
	</section>
...
<div class="container">
	...
	<div class="row">
		<div class="row row-padding-mmy">
			<div class="col-md-12 text-center">
				<h3 class="category-title">Newborn</h3>
			</div>
		</div>
		<div class="row row-padding-mmy">
	...
	<div class="row">
		<div class="row row-padding-mmy">
			<div class="col-md-12 text-center">
				<h3 class="category-title">Toddler</h3>
			</div>
		</div>
		<div class="row row-padding-mmy">
