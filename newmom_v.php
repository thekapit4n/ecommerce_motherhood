...
<div class="main-div-nemum">
	<div class="row step1">
		<div class="container" style="position: relative; text-align: center;">
			<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/main-page.png" width="100%" /> 
			<div class="col-md-12" style="padding-right: 23px;">
				<div class="row" style="margin-top:25px;">
					<div class="col-md-12">
						<p class="question-font" style="font-size: 30px; font-weight: 700; line-height:33px;">Meet Motherhood.com.my your new mom life support<p>
						<p style="font-size: 27px;margin-top:20px;line-height:31px;">First, let's  collect your gift! Which one are you now?</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12" style="margin-top: 30px;">
						<div class="col-md-offset-2 col-md-4 col-xs-12" style="margin-bottom:10px">
							<button class="btn btn-default btn-step1 step1btnv1" data-typepregnancy="pregnant" data-formstep="1"> 
								I'm Pregnant
							</button>
						</div>
						<div class="col-md-3 col-xs-12">
							<button class="btn btn-default btn-step1 step1btnv1" data-typepregnancy="babyOut" data-formstep="2"> 
							I'm a New Mum 
							</button>
						</div>
	...
	<div class="row step2v1" style="display: none; background-size: cover; background-position: top center; background-repeat: no-repeat; padding-top: 20px; padding-bottom: 20px;">
	   ...
	   <div class="col-md-8" style="margin-top: 50px;" align="center">
		  <p style="font-size: 30px; font-weight: bold;margin-bottom:35px" class="main-title-color">What will you get</p>
		  <div class="row">
				...
				<div class="col-md-4 col-xs-6">
				 ...
				 <div class="col-md-4 col-xs-6">
					<div style="min-height:170px">
						<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/box.png" width="100%" alt="newmombox" />
						<p style="font-size: 17px; font-weight: bold; padding-top: 20px; padding-bottom: 0px; line-height: 1;min-height: 53px;" class="main-title-color">Exclusive Baby Box!*</p>
						<p style="font-size: 13px; font-weight: normal; padding-top: 0; padding-bottom: 0px; line-height: 1;" class="tnc-word-color">Limited to 50 new moms per month. T&amp;C Apply</p>
					</div>
				 </div>
		  </div>
	   </div>
	   ...
	   <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
			<button type="button" class="btn btn-default btn-step1 step2btnv1"> 
				Next
			</button>
	   </div>
	   <div class="clearfix"></div>
	...
	<div class="row step3v1" style="display:none; padding-top: 20px; padding-bottom: 20px;">
		...
		<div class="col-md-8 text-left" style="margin-top: 50px;">
			<div class="row" style="margin-bottom:15px;">
				<p class="question-font">
					Do you want to learn more about Cord Blood Stem Cells Banking?
				</p>
				<div class="col-md-6">
					<label class="label-custom lblcordblood"> 
						<input type="radio" name="subscriber_question12" class="cordblood" value="Yes" />Yes 
					</label>
				</div>
				<div class="col-md-6">
					<label class="label-custom lblcordblood"> 
						<input type="radio" name="subscriber_question12" class="cordblood" value="No" />No 
					</label>
				</div>
			</div>
			<div class="row">
				<p class="question-font">
				Are you planning to deliver at a private or government hospital?
				</p>
				<div class="col-md-6">
					<label class="label-custom lblhospquest"> 
						<input type="radio" name="subscriber_question13" class="hospitalquestion" value="PRIVATE" />Private 
					</label>
				</div>
				<div class="col-md-6">
					<label class="label-custom lblhospquest"> 
						<input type="radio" name="subscriber_question13" class="hospitalquestion" value="GOVERNMENT" />Goverment 
					</label>
				</div>
			</div>
		  <div class="clearfix"></div>
	   ...
	   <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
		<div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
			<button type="button" class="btn btn-default btn-step1 step3btn"> 
				Next
			</button>
		</div>
	</div>
	...
	<div class="row step2v2" style="display:none; padding-top: 20px; padding-bottom: 20px;">
	   ...
	   <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
	   <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
			<button type="button" class="btn btn-default btn-step1 step2btn"> 
				Next
			</button>
		</div>
	   <div class="clearfix"></div>
	...
	<div class="row step3v2" style="display: none; padding-top: 20px; padding-bottom: 20px;">
	   ...
	   <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
	   <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
			<button type="button" class="btn btn-default btn-step1 step3v2btn"> 
				Next
			</button>
		</div>
	</div>
	   ...
	   <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
		  <p style="font-size: 3em; color: #005b9c; font-weight: bold; padding-top: 20px; padding-bottom: 20px; line-height: 1;">It&rsquo;s time to receive your welcome kit!</p>
			<div class="col-md-6 text-left question-welcomekit">
				<label>Email</label>
				<input type="email" id="emailNew" name="newEmail" class="form-control" placeholder="Email" required="required" style="background-color:white"/>
				<small class="error-msg"></small>
			</div>
			<div class="col-md-6 text-left question-welcomekit">
				<label>Password</label>
				<input type="password" id="newPassword" name="newPassword" class="form-control" minlength="6/" placeholder="Password" required="required" />
				<small class="error-msg"></small>
			</div>
		  <div class="clearfix"></div>
			<div class="col-md-6 text-left question-welcomekit">
		  ...
		  <div class="col-md-7 text-left question-welcomekit">
				...
				<input type="number" id="subscriber_question1" name="subscriber_question1" style="width: 90%; font-size: 14px; padding-top: 10px; padding-bottom: 10px; ;display: inline-block; border: 1px solid #ccc; box-shadow: inset 0 1px 3px #ddd; border-radius: 4px; vertical-align: middle; box-sizing: border-box; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" title="xxx xxxxx" placeholder="Mobile Number" pattern=".{10,}" onkeydown="javascript: return event.keyCode == 69 ? false : true" required="required" /> 
				<small class="error-msg"></small>
		  </div>
		  <div class="clearfix"></div>
			<div class="col-md-12 text-left question-welcomekit">
				<label>Full Address</label>
				<input type="text" name="subscriber_question8" id="subscriber_question8" size="80" required="required" placeholder="Full Address" class="form-control" />
				<small class="error-msg"></small>
			</div>
		  <div class="clearfix"></div>
			<div class="col-md-4 text-left question-welcomekit">
				<label>Postcode</label>
				<input type="number" name="subscriber_question9" id="subscriber_question9" class="form-control" size="10" required="required" onkeydown="javascript: return event.keyCode == 69 ? false : true" placeholder="Postcode" />
				<small class="error-msg"></small>
			</div>
			<div class="col-md-4 text-left question-welcomekit">
				<label>City</label>
				<input name="subscriber_question10" id="subscriber_question10" type="text" size="60" required="required" placeholder="City" class="form-control" />
				<small class="error-msg"></small>
			</div>
			...
			<div class="col-md-4 text-left question-welcomekit">
				...
				<input name="subscriber_question14" type="date" id="dobParent"  required="required" placeholder="DOB" class="form-control dob-parent" />
				<small class="error-msg"></small>
			</div>
			<div class="clearfix"></div>
			<div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
				<button type="button" name="submit" id="btn-submit-form1" class="btn btn-default btn-step1 "> 
					Submit
				</button>
			</div>
	   </div>
...
<div class="row edd-row" style="display:none;">
	...
	<div class="container" style="position: relative; text-align: center;margin-bottom:30px">
		<img src="https://via.placeholder.com/300x100?text=Visit+Blogging.com+Now" width="100%" /> 
	</div>
	...
	<div class="col-md-4 text-left" style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
		<select id="momDay" disabled="disabled" style="width: 100%; font-size: 1.1em; box-shadow: none!IMPORTANT; color: #512f2e;">
		 ...
		 <small class="error-msg"></small>
		<input type="hidden" name="subscriber_question2" id="subscriber_question2" /> <!-- date EDD -->
	</div>
	<div class="clearfix"></div>
	<div class="col-md-4 col-md-offset-4" style="padding-top: 20px;">
		<button type="button" name="submit" id="btn-submit-form2" class="btn btn-default btn-step1 " disabled> 
			Submit
		</button>
	</div>
</div>
<p>
   <script>// <![CDATA[
		...
		$(document).ready(function(){
			...
			$('body').on('change', '#emailNew, #newPassword, #newFirstName, #newLastName, #subscriber_question1, #subscriber_question8, #subscriber_question9, #subscriber_question10, #subscriber_question11, #dobParent', function(){
			...
			$('body').on('change', '.cordblood, .hospitalquestion', function(){
				var isCordBloodCheck 		= $('body').find('.cordblood').is(':checked');
				var isHospitalQuestionCheck = $('body').find('.hospitalquestion').is(':checked');
				
				console.log("isCordBloodCheck" + isCordBloodCheck + "isHospitalQuestionCheck" + isHospitalQuestionCheck)
