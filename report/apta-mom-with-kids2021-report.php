...
if(isset($_GET['islogout']) && $_GET['islogout'] == true)
{
	...
	header('Location: http://www.motherhood.com.my/external/apta-mom-with-kids2021-report.php');
}
					...
					<div class="row justify-content-center">
						...
						<div class="col-md-12">
							<div class="form-block" style="padding-top:20px;padding-bottom:20px;">
								...
								<form action='apta-mom-with-kids2021-report.php' method='post' method="post">
...
<head>
	...
	<title>Apta mom with kids 2021 | Motherhood.com.my Malaysia</title>
<style>
body{
	font-family: 'Poppins', sans-serif;
}
    ...
    function mysql_result_all_html($result, $offset = 0) {
		...
		while ($r = mysqli_fetch_row($result)) {
			...
			foreach ($r as $indx => $kolonne) {
					...
					{
						$table .= "<td>" . $kolonne . "</td>";
						$table .= "<td>I have child / children more than 1 year old</td>";
					}
					else
						$table .= "<td>" . $kolonne . "</td>";
			}
...
?>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="padding-top:0px;padding-bottom:0px">
	  <!-- Links -->
		...
		<ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
			<li class="nav-item">
				<a href="apta-mom-with-kids2021-report.php?islogout=true" class="nav-link p-2" href="" target="_blank" rel="noopener" aria-label="GitHub">
			...
			<div class="row row-motherhood" style="margin-top:40px;">
				<div class="col-md-8">
					<div class="page-header">
						<h3>Apta Mom Kids 2021 | Motherhood.com.my Malaysia</h3>
					</div>
				</div>
			</div>
	...
	$(function(){
		...
		$('body').on('click', '#btn-submit', function(){
			...
			if(isExport)
			{
				$('body').find('#form-request').attr('action', 'apta-mom-with-kids2021-excel.php');
			}
			else
			{
				$('body').find('#form-request').attr('action', 'apta-mom-with-kids2021-report.php');
			}
