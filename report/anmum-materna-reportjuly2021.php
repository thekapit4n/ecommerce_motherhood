...
if(isset($_GET['islogout']) && $_GET['islogout'] == true)
{
	...
	header('Location: http://www.motherhood.com.my/external/anmum-materna-reportjuly2021.php');
}
...
<form action='anmum-materna-reportjuly2021.php' method='post'>
		<div style="row">
			...
			<div class="form-container">
				...
				Anmum Materna Report July 2021 | Motherhood.com.my Malaysia
				</div>
				<div class="form">
					<div class="text">
						Login:
...
<title>Anmum materna report july 2021 | Motherhood.com.my Malaysia</title>
<style>
body{
...
<?php
	...
	{
		$wheresql .= (($wheresql == '') ? " WHERE " : " AND " ) . "a.subscriber_created_at >= '2021-07-27 00:00:00'";
	}
...
?>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="padding-top: 1px; padding-bottom: 1px;">
	  <!-- Links -->
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a href="anmum-materna-reportjuly2021.php?islogout=true" class="nav-link p-2" href="" target="_blank" rel="noopener" aria-label="GitHub">
			...
			<div class="row row-motherhood" style="margin-top:40px;">
				<div class="col-md-8">
					<div class="page-header">
						<h3>Anmum materna report july 2021 | Motherhood.com.my Malaysia</h3>
					</div>
				</div>
			</div>
			<form id="form-request" method='post' action="anmum-materna-reportjuly2021.php">
	...
	$(function(){
		...
		$('body').on('click', '#btn-submit', function(){
			...
			if(isExport)
			{
				$('body').find('#form-request').attr('action', 'anmum-materna-reportjuly2021-excel.php');
			}
			else
			{
				$('body').find('#form-request').attr('action', 'anmum-materna-reportjuly2021.php');
			}
