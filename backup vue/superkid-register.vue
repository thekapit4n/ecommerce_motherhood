        ...
        <div class="div-mobile-main content-3" style="display: none">
            <div class="" style="width: 100%">
                <div class="step-1 mb-5">
                    ...
                    <ValidationObserver ref="parentinfo">
                        <b-form class="row mx-0" slot-scope="{ validate }" @submit.prevent="validate().then(submitParentInfo)">
                            ...
                            <ValidationProvider rules="required" name="State" class="col-12 px-0">
                                <b-form-group slot-scope="{ valid, errors }" label="State">
                                    
                                    <!-- <select
                                        class="form-control state-select"
                                        name="state"
                                        @change="inputField(0, $event, 'state')"
                                        required
                                    >
                            ...
                            <div class="col-12 px-0">
                                    <b>
                                        Are you interested to receive other free
                                        gifts/samples from brands below? If yes,
                                        please select:
                                    </b>
                                    <b-form-checkbox-group
                                        v-model="form.parent_gift"
                                        :options="parent_gift"
                                        plain
                                        stacked
                                        class="form-check-box"
                                    >
                                        <!-- <b-form-invalid-feedback :state="checkboxState">
                                            Please select one
                                        </b-form-invalid-feedback> -->
                                    </b-form-checkbox-group>
                            </div
                            ...
                            <div class="col-12 px-0 mb-3">
                                    <b>
                                        Would you like to learn more about Family Insurance?
                                    </b>
                                    <b-form-checkbox-group
                                        v-model="form.family_insurance"
                                        plain
                                        stacked
                                        class="form-check-box"
                                    >
                        ...
                        <!-- <div class="row row-display-content col-md-12">
                            <div class="col-md-12 form-group">
                                <b>Are you interested to receive other free
                                    gifts/samples from brands below? If yes,
                                    please select:
                                </b>
                        ...
                        <div class="row-mobile col-md-12 pb-5">
                            <button
                                type="submit"
                                class="
                                    btn btn-primary btn-lg btn-block btn-journey
...
export default {
        ...
        activityBox: [
            {
                ...
                image: "https://media.motherhood.com.my/175936-large_default/superkids-club-activity-box-free.jpg",
            },
        ],
        events: [
            {
    ...
    methods: {
        ...
        submitParentInfo() {
            ...
            this.$refs.parentinfo.validate().then(success => {
                if (!success || length < 1) {
                    return;
                }
