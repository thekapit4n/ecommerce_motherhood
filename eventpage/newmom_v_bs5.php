...
<div class="main-div-nemum">
   ...
   <div class="row step2v1" style="display: none; background-size: cover; background-position: top center; background-repeat: no-repeat; padding-top: 20px; padding-bottom: 20px;">
      ...
      <div class="col-md-12" style="margin-top: 20px;" align="center">
         ...
         <div class="row">
            ...
            <div class="col-md-3 col-xs-3">
               <div class="benefit-div">
                  <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/September/sept.png" width="100%" alt="newmomcardandgiftcard" />
            ...
            <div class="col-md-3 col-xs-3">
               <div class="benefit-div">
                  <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/July/Newmom/luckydrawjuly.png" width="100%" alt="luckydraw" />
   ...
   <div class="row step3" style="display: none; padding-top: 20px; padding-bottom: 20px;">
        ...
        <div class="row mb-2">
            <div class="col-md-6 px-2">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" id="subscriber_question1" name="subscriber_question1" aria-describedby="basic-addon1" placeholder="Mobile Number" pattern=".{10,}" onkeydown="javascript: return event.keyCode == 69 ? false : true" required="required" >
                </div>
                <small class="error-msg"></small>
            </div>
        </div>
        ...
        <div class="row mb-2 row-mommymilk" style="display: none;">
            <div class="col-md-12 px-2">
               <label>What brand of milk does mommy like or is currently consuming?</label>
                <select class="form-select selection-mommymilk" name="subscriber_question18" aria-label="" style="height: 37px;">
        ...
        <div class="row mb-2 row-kidmilk" style="display: none;">
            <div class="col-md-12 px-2">
               <label>What milk brand is your kid currently consuming?</label>
                <select class="form-select selection-kidmilk" name="subscriber_question19" aria-label="" style="height: 37px;">
                    <option disabled="disabled" selected="selected" value="">Choose one</option>
    ...
    <div class="row huggies-row" style="display: none; padding-top: 20px; padding-bottom: 20px;">
        <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
         ...
         <p style="font-size: 3em; color: #005b9c; font-weight: bold; padding-top: 20px; padding-bottom: 20px; line-height: 1;">Redeem FREE Huggies Natural Soft Diaper Samples</p>
            ...
            <div class="row mb-2">
                <div class="col-md-6 px-2">
                    <label class="form-label required">What is your preferred diaper size ?</label> 
                    <select name="subscriber_question15" id="huggies-preferred-size"  class="form-select" required="required">
                ...
                <div class="col-md-6 px-2">
                    <label class="form-label required">What is your preferred diaper type ?</label> 
                    <select name="subscriber_question16" id="huggies-preferred-type" class="form-select" required="required">
            ...
            <div class="row mb-2">
                <div class="col-md-6 px-2">
                    ...
                    <select name="subscriber_question17" id="huggies-preferred-lang" class="form-select" required="required">
            ...
            <div class="row mb-4 mt-4">
                <div class="col-md-12 px-2  text-center">
                    <button type="button" class="btn btn-default btn-step1 btn-next-huggies" id="btn-next-huggies"> Next </button>
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="row">
   ...
   <script>// <![CDATA[
      ...
      var manageBtnKit = function(){
      	...
      	if(typePregnancy.toLowerCase() == 'pregnant')
      	{
      		...
      		$('body').find('.row-mommymilk').hide('fast');
      		$('body').find('.row-kidmilk').hide('fast');
      		$('body').find('.selection-kidmilk').attr('required', false);
      		$('body').find('.selection-mommymilk').attr('required', false);
      	}
      	else if(typePregnancy.toLowerCase() == 'babyout')
      	{
      		...
      		$('body').find('.row-mommymilk').show('fast');
      		$('body').find('.row-kidmilk').show('fast');
      		$('body').find('.selection-kidmilk').attr('required', true);
      		$('body').find('.selection-mommymilk').attr('required', true);
      	}
      }
      ...
      $(".tncbtn").on("click", function () {
      	...
      	$('body').on('change', '#emailNew, #newPassword, #newFirstName, #newLastName, #subscriber_question1, #subscriber_question8, #postcode-address, #city-address, #state-address, #dobParent, #huggies-preferred-size, #huggies-preferred-type, #huggies-preferred-lang', function(){
