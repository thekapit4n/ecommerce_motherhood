...
<div class="row step-pregnant" style="display: none;">
   ...
   <div class="row">
      ...
      <div class="col-md-3 col-12">
         <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2022/Jan/Newmom/newmom-2022.png" width="100%" alt="exclusive rewards" />
               ...
               <div id="tnc1" class="accordion-collapse collapse show" aria-labelledby="tnc1header" data-bs-parent="#tncaccordian">
                  <div class="accordion-body">
                     <ul style="list-style: disc;">
                        ...
                        <li class="mb-3">Gifts may vary depend on the availability.</li>
...
<div class="row step-form" style="display: none;">
   ...
   <div class="row my-2">
      <div class="col-md-12 px-2">
         ...
         <div class="form-check form-check-inline">
		 	...
		 	<label class="form-check-label noUniform px-3 py-1" style="font-weight: 400;"> Yes </label></div>
      </div>
   </div>
   <div class="row my-2 row-sample-milk">
      <div class="col-md-12 px-2">
         ...
         <!--
            <div class="form-check form-check-inline">
            	<input class="form-check-input noUniform option-other-milkbrand" type="checkbox" value="Wyeth Promama" id="option-milk-b" /> 
            	<label class="form-check-label noUniform px-3 py-1" for="option-milk-a" style="font-weight: 400;">  Wyeth Promama </label>
            </div>
...
<div class="row step-cryocord" style="display: none;">
   ...
   <input type="hidden" class="hidden-check-edd" value="false" /> <input type="hidden" class="hidden-check-mobile" value="false" /> <input type="hidden" class="hidden-check-email" value="false" /> <input type="hidden" class="hidden-list-sampling" value="" /> <button type="submit" name="submit" id="btnsubmit" style="display: none;">dummy</button>
   <script>// <![CDATA[
      ...
      var checkEmail = function(sample = false, autorun = false){
      	...
      	if(checkemail != undefined && checkemail != '')
      	{
      		...
      		$.ajax({
      			...
      			data	 :{'checkemail': checkemail, 'eventid': eventID, 'checksample': sample},
      			dataType :'json',
      			method 	 : 'post',
      			success	 : function(result){
