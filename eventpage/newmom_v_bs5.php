   ...
   <div class="row mt-3">
      <div class="col-sm-6">
         <div class="card mb-3 card-clickable" data-usertype="pregnant" style="max-width: 500px;">
            <div class="row g-0">
               <div class="col-md-4 col-4"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2022/Jan/Newmom/pregnant-01.svg" class="img-fluid rounded-start" style="width: 85%;" alt="pregnant-image" /></div>
      ...
      <div class="col-sm-6">
         <div class="card mb-3 card-clickable" data-usertype="babyOut" style="max-width: 500px;">
            <div class="row g-0">
               <div class="col-md-4 col-4"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2022/Jan/Newmom/postpartum-01.svg" class="img-fluid rounded-start" style="width: 85%;" alt="newmom-image" /></div>
               <div class="col-md-8 col-8">
                  <div class="card-body">
...
<div class="row step-pregnant" style="display: none;">
   ...
   <div class="row my-4">
      <div class="col-md-12 text-center"><button type="button" class="btn btn-primary btn-step-back mb-3 mx-2" data-usertype="pregnant" data-step="1"> Back </button> <button type="button" class="btn btn-primary btn-step-forward mb-3 mx-2" data-usertype="pregnant" data-step="3"> Next </button></div>
   </div>
   <div class="row my-5">
      <div class="col-md-6 px-2">
         ...
         <div class="accordion" id="tncaccordian">
            <div class="accordion-item">
               <h2 class="accordion-header" id="tnc1header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#tnc1" aria-expanded="true" aria-controls="tnc1"> Details </button></h2>
      ...
      <div class="col-md-6 px-2">
         ...
         <div class="accordion" id="faqaccordian">
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq1header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1" aria-expanded="false" aria-controls="faq1"> How do I apply for a New Mom member card? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq2header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="false" aria-controls="faq2"> Can I register again if I am already a member? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq3header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq3"> Can I apply for the programme if I am not a Malaysian citizen? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq4header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false" aria-controls="faq4"> How much is the New Mom Program fee? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq5header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq5" aria-expanded="false" aria-controls="faq5"> How do I redeem the free gift(s)? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq6header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq6" aria-expanded="false" aria-controls="faq6"> How long does it take to deliver my gift(s)? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq7header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq7" aria-expanded="false" aria-controls="faq7"> What are the benefits of having a New Mom member card? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq8header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq8" aria-expanded="false" aria-controls="faq8"> When will my New Mom member card expire? </button></h2>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="faq9header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq9" aria-expanded="false" aria-controls="faq9"> How do I renew my New Mom member card? </button></h2>
...
<div class="row step-newmom" style="display: none;">
   ...
   <div class="row my-4">
      <div class="col-md-12 text-center"><button type="button" class="btn btn-primary btn-step-back mb-3 mx-2" data-usertype="babyout" data-step="1"> Back </button> <button type="button" class="btn btn-primary btn-step-forward mb-3 mx-2" data-usertype="babyout" data-step="3"> Next </button></div>
   </div>
   <div class="row my-5">
      <div class="col-md-6 px-2">
         <p style="font-size: 2em; font-weight: bold;">Terms &amp; Conditions</p>
...
<div class="row step-newbaby-dob" style="display: none;">
   ...
   <div class="row">
      <div class="col-md-12 text-center" style="padding-top: 20px;">
         ...
         <button type="button" class="btn btn-primary btn-step-back mb-3 mx-2" data-usertype="babyout" data-step="2"> Back </button> <button type="button" class="btn btn-primary btn-step-forward mb-3 mx-2" data-usertype="babyout" data-step="4"> Next </button>
      </div>
   </div>
</div>
<div class="row step-form" style="display: none;">
   ...
   <div class="row my-1">
      <div class="col-md-12 px-2 text-left"><label for="newEmail" class="form-label required">Mandotary field</label></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="newEmail" class="form-label required">Email</label> <input type="email" class="form-control" id="emailNew" name="newEmail" placeholder="Email" required="required" /> <small class="error-msg-email"></small></div>
      <div class="col-md-6 px-2"><label for="newPassword" class="form-label required">Password</label> <input type="password" class="form-control" id="newPassword" name="newPassword" minlength="6/" placeholder="Password" required="required" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="firstname" class="form-label required">First name</label> <input type="text" id="newFirstName" name="newFirstName" class="form-control" placeholder="First Name" required="required" /> <small class="error-msg"></small></div>
      <div class="col-md-6 px-2"><label for="lastname" class="form-label required">Last Name</label> <input type="text" id="newLastName" name="newLastName" class="form-control" placeholder="Last Name" required="required" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-6 px-2">
   ...
   <div class="row mb-2">
      <div class="col-md-12 px-2"><label for="fulladdress" class="form-label required">Full Address</label> <input type="text" id="subscriber_question8" name="subscriber_question8" class="form-control" placeholder="Full Address" required="required" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode"><label for="postcode-address" class="form-label required">Postcode</label> <input type="text" class="form-control addr-postcode" id="postcode-address" name="subscriber_question9" required="" placeholder="Postcode" /> <small class="error-msg"></small></div>
      <div class="col-md-4 px-2 mb-3 mb-md-1"><label for="city-address" class="form-label required">City</label> <input type="text" class="form-control addr-city" id="city-address" name="subscriber_question10" required="" placeholder="City" /> <small class="error-msg"></small></div>
      <div class="col-md-4 px-2 mb-3 mb-md-1">
   ...
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="fulladdress" class="form-label required">Your Date of Birth</label> <input type="text" id="dobParent" name="subscriber_question14" class="form-control" placeholder="your dob" required="required" /> <small class="error-msg"></small></div>
      <div class="col-md-6 px-2 div-edd-question"><label for="fulladdress" class="form-label required">Estimated Date of Delivery(EDD)</label> <input type="text" id="pregnantedd" name="subscriber_question20" class="form-control" placeholder="EDD" required="required" /> <small class="error-msg"></small></div>
   </div>
   ...
   <div class="row my-2">
      <div class="col-md-12 px-2">
         <div class="row" style="margin-left: 1px;"><label class="form-label">Would you like to learn more about Maternity and Newborn Insurance?</label></div>
         <div class="form-check form-check-inline"><input class="form-check-input noUniform" type="checkbox" value="yes" name="subscriber_question22" /> <label class="form-check-label noUniform px-3 py-1" style="font-weight: 400;"> Yes </label></div>
      </div>
   </div>
   <div class="row my-2 row-sample-milk">
      <div class="col-md-12 px-2">
         ...
         <div class="form-check form-check-inline"><input class="form-check-input noUniform option-other-milkbrand" type="checkbox" value="Enfamama A+" id="option-milk-a" /> <label class="form-check-label noUniform px-3 py-1" for="option-milk-b" style="font-weight: 400;"> Enfamama A+ </label></div>
         <!--
   ...
   <div class="row mb-4 mt-4">
      <div class="col-md-12 px-2  text-center"><button type="button" class="btn btn-primary btn-step-back step-backform mb-3 mx-2"> Back </button> <button type="button" class="btn btn-primary btn-submit btn-submit-form step-forwardform mb-3 mx-2"> Submit </button></div>
   </div>
</div>
<div class="row step-cryocord" style="display: none;">
   <div class="row">
      ...
      <div class="row">
         <div class="col-md-12 text-center" style="padding-top: 20px;"><button type="button" class="btn btn-primary btn-step-back step-backform-cryocord mb-3 mx-2"> Back </button> <button type="button" class="btn btn-default btn-submit btn-pregnant-submit mb-3 mx-2"> Submit </button></div>
      </div>
   </div>
   <input type="hidden" class="hidden-check-edd" value="false" /> <input type="hidden" class="hidden-check-mobile" value="false" /> <input type="hidden" class="hidden-check-mobile-register" value="false" /> <input type="hidden" class="hidden-check-email" value="false" /> <input type="hidden" class="hidden-list-sampling" value="" /> <button type="submit" name="submit" id="btnsubmit" style="display: none;">dummy</button>
   <script>// <![CDATA[
      var icon = '<i class="fa fa-info-circle"></i>';
            ...
            if(mobileno.length >= 10)
            {
                $.ajax({
                  ...
                  success	 : function(result){
                    ...
                    if(result.status == true)
                      $('body').find('.hidden-check-mobile-register').val(true)
                    else if(result.status == false){
                      $('body').find('.hidden-check-mobile-register').val(false)
                      Swal.fire({
                        icon: 'error',
                        title: 'Mobile Number Registered',
                        text: 'Your mobile number has been registered',
                      });
          ...
          var checkDisbaled_btn = function(){
              var mobileCheck =  $('body').find('.hidden-check-mobile-register').val();
              var emailCheck = $('body').find('.hidden-check-email').val();

              if(mobileCheck  == 'false' || emailCheck == 'false')
              {
          ...
          $(function() {
            ...
            $('body').on('click', '.btn-pregnant-submit, .btn-newmom-submit', function() {
              var usertype = $('#subscriber_question4').val();
              var checkmobile = $('body').find('.hidden-check-mobile').val();
              var checkmobilereg = $('body').find('.hidden-check-mobile-register').val();
              var checkedd = $('body').find('.hidden-check-edd').val();
              var res = checkbasic_input_form();
              if (res == false) {
                return false;
