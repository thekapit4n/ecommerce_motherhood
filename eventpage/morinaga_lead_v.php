...
<div class="container">
   <div class="row mb-2" style="margin-left: 0px; margin-right: 0px; margin-bottom: -15px !important;">
      <div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px;">
        ...
        Get a Morinaga Chil-kid 600g trial pack at RM 20 only
		</div>
	  </div>
   </div>
   <div style="background-color: #f7f7f7; padding-top: 40px;">
		...
		<div class="row mb-2 mb-2 px-md-5 mx-md-5">
			<div class="col-md-6 px-2">
				...
				<small><i class="fas fa-info-circle"></i> Applicable for children 1 to 7 years old only</small>
			</div>
		 <div class="col-md-6 px-2">
             ...
             <div class="col-md-12 px-2">
                 <div class="form-check">
                     ...
                     <label class="form-check-label noUniform px-3" for="tnccheckbox"> 
                        By submitting this form, I hereby agree to the Terms and Conditions and consent to the collection and processing of my personal data by OZ MARKETING SDN BHD in accordance with the Privacy Policy.
                        I hereby consent to receive Morinaga Malaysia information via mail/sms/phone/email and trial pack*. Collected data can also be used for customer service purpose.
                     </label>
                 </div>
             </div>
         </div>
         ...
         <div class="row my-4 px-md-5 mx-md-5">
            <div class="col-md-12 px-2 py-4" style="color: white;">
               ...
               <ol style="list-style: decimal; padding-left: 20px;" start="1">
                  <li class="text-left tnc_li">This redemption is only valid for parents with children aged between 1 to 7 years old.</li>
...
<p>
   ...
   <script>// <![CDATA[
	...
	$(function(){
		...
		var minAge =  "01/01/" + (currentYear-7);
