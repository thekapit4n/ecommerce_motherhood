   ...
   <div class="panel-group" id="accordion">
      <div class="panel panel-default">
         <div class="panel-heading heading-details-info" data-toggle="collapse" data-parent="#accordion" data-target="#infoform" style="text-align: left; color: #fff; background-color: #2ea7ad; border-color: #2ea7ad;">
            <h4 class="panel-title">Details Information <span style="float: right;" class="ikon-collapse">{{pre-define-class-collapse-icon}}</span></h4>
         </div>
         <div id="infoform" class="panel-collapse collapse {{pre-define-class-collapse}}">
                  ...
                  <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
                     ...
                     <div class="row row-form row-question-milk-brand {{div-class-question-milk-brand}}">
                        <div class="col-md-6 text-left question-welcomekit">
                           ...
                           <select id="milk-brand" name="subscriber_question9" style="width: 100%; height: 37px; font-size: 14px; padding-top: 7px; padding-bottom: 5px; display: inline-block; border: 1px solid #ccc; box-shadow: inset 0 1px 3px #ddd; border-radius: 4px; vertical-align: middle; box-sizing: border-box; margin-top: 0px;" required="required">
...
<div  class="row row-feature" style="position: relative;">
   ...
   <!-- due date calculator -->
   <div class="tools-motherhood dueDateCalculator visuallyhidden">
   ...
   <!-- baby journey tools -->
   <div class="tools-motherhood babyJourney visuallyhidden">
      <!--
         <div id="edd-form" class="row {{pre-define-display-eddform}}">
           <div class="col-lg-12 col-md-12">
         	 <div class="col-md-12" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
         		...
         		<div class="col-md-4" style="padding-left: 5px; padding-right: 5px;">
         		   <select id="babyYear"  style="width: 100%; font-size: 1.7em; box-shadow: none!IMPORTANT; border-radius: 0!IMPORTANT;">
         		...
         		<div class="col-md-4" style="padding-left: 5px; padding-right: 5px;">
         		   <select id="babyMonth" disabled="disabled" style="width: 100%; font-size: 1.7em; box-shadow: none!IMPORTANT; border-radius: 0!IMPORTANT;">
         		...
         		<div class="col-md-4" style="padding-left: 5px; padding-right: 5px;">
         		   <select id="babyDay" disabled="disabled" style="width: 100%; font-size: 1.7em; box-shadow: none!IMPORTANT; border-radius: 0!IMPORTANT;">
         			  <option value="" disabled="disabled" selected="selected">Day</option>
         		   </select>
         		   <input type="hidden" name="subscriber_question8" id="edd-question" />
         		</div>
         		<div class="clearfix"></div>
         	 </div>
         	 <div class="col-md-12" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
		   ...
		   {{pre-define-display-pregnancytracker}}
           -->
      <div id="div-pregnancytracker" class="row ">
         <div class="row" style="padding-top: 20px;">
            <div class="col-md-12">
				<div class="row" style="margin-bottom:15px;">
					<div class="row row-form question-edd" style="margin-bottom:15px;padding-left:40px;padding-right:40px;">
                        <div class="col-md-12 text-left question-welcomekit"><label>Estimate Date of Delivery (EDD)</label></div>
                        <div class="col-md-4 text-left question-welcomekit question-edd {{div-class-question-edd}}">
                           <select id="babyYear" style="width: 100%; height: 37px; font-size: 14px; padding-top: 7px; padding-bottom: 5px; display: inline-block; border: 1px solid #ccc; box-shadow: inset 0 1px 3px #ddd; border-radius: 4px; vertical-align: middle; box-sizing: border-box; margin-top: 0px;">
                              <option value="" disabled="disabled" selected="selected">Year</option>
                              <option value="2021">2021</option>
                        ...
                        <div class="col-md-4 text-left question-welcomekit question-edd {{div-class-question-edd}}">
                           <select id="babyMonth" disabled="disabled" style="width: 100%; height: 37px; font-size: 14px; padding-top: 7px; padding-bottom: 5px; display: inline-block; border: 1px solid #ccc; box-shadow: inset 0 1px 3px #ddd; border-radius: 4px; vertical-align: middle; box-sizing: border-box; margin-top: 0px;">
                              <option value="" disabled="disabled" selected="selected">Month</option>
                              <option value="1">January</option>
                              <option value="2">February</option>
                              <option value="3">March</option>
                        ...
                        <div class="col-md-4 text-left question-welcomekit">
                           <select id="babyDay" disabled="disabled" style="width: 100%; height: 37px; font-size: 14px; padding-top: 7px; padding-bottom: 5px; display: inline-block; border: 1px solid #ccc; box-shadow: inset 0 1px 3px #ddd; border-radius: 4px; vertical-align: middle; box-sizing: border-box; margin-top: 0px;" >
                              <option value="" disabled="disabled" selected="selected">Day</option>
                           </select>
                        </div>
                    </div>
					<div class="row" style="padding-left:40px;padding-right:40px;">
						 <div class="col-md-12 text-left question-welcomekit"><small class="edd-msg"></small></div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<input type="hidden" id="edd-question" value="">
							<button type="button" class="btn btn-default btn-step1 btn-submtit-edd"> Submit </button>
						</div>
					</div>
				</div>
				<div class="row babyweek-text-row" style="display:none;">
					<div class="col-md-12 yourWeek">
						<p style="color: #25a7ae; font-size: 2em; padding-top: 15px; line-height: 1.2;" class="wording-baby-weeks">Your baby is on week <font class="text-weekpregnant"></font>!</p>
					</div>
				</div>
               <div class="row">
               ...
               <div class="row">
                  <div class="col-md-12 slider-dummy-class enlinea_slider_custom">
   ...
   <!-- E-magazine tool -->
   <div class="tools-motherhood eMag visuallyhidden" style="min-height: 400px;">
      <div class="row">
...
<p>
   <script>// <![CDATA[
      /** if other function that need to use same input for validation, we can just use this selector  **/
      	...
      	var eddCheck = function(){
      		var babyyear 	 = $('body').find('#babyYear').val();
      		var babymonth	 = $('body').find('#babyMonth').val();
      		var babyday	 	 = $('body').find('#babyDay').val();
      		var edd 		 = eddSelector.val();
      		var subscribe_id = subidSelector.val();
      		
      		if(babyyear == '' ||  babyyear == null || babyyear == undefined)
      		{
      			alert('Plese select year of edd');
      			return false;
      		}
      		
      		if(babymonth == '' ||  babymonth == null || babymonth == undefined)
      		{
      			alert('Plese select month of edd');
      			return false;
      		}
      		
      		if(babyday == '' ||  babyday == null || babyday == undefined)
      		{
      			alert('Plese select day of edd');
      			return false;
      		}
      		
      		// eddCheckedInpSelector.val(false);
      		if(edd != '')
      		{
      			msg = "<i class='fas fa-spinner fa-spin'></i> Please wait while we validate your EDD...";
      			$('body').find('.edd-msg').html(msg);
      			$.ajax({
      				...
      				success	 : function(result){
      					...
      					if(result.status == true)
      					{
      						$('body').find('.edd-msg').html('<i class="far fa-check-circle"></i> valid EDD');
      						$('body').find('.text-weekpregnant').html(result.data.week);
      						$('body').find('.babyweek-text-row').show('fast');
      						// eddCheckedInpSelector.val(true);
      					}
      					else
      					{
							$('body').find('.babyweek-text-row').hide('fast');
      						// eddCheckedInpSelector.val(false);
      						if(result.status_code == 'negative_edd')
      						{
      							$('body').find('.edd-msg').html(icon + " Error, please enter your EDD again [" + result.data.week + " weeks]");
      						}
      						else if(result.status_code == "overdue_pregnancy")
      						{
      							$('body').find('.edd-msg').html(icon + " Overdue pregnancy [" + result.data.week + " weeks]");
      						}
							else
							{
								$('body').find('.edd-msg').html(icon + result.msg);
							}
      					}
      					// checkStatusInput();
      				}
      		...
      		{
      			// alert('Please edd date and submit your information first before submit edd');
      			// checkStatusInput();
      		}
      	}
		...
		var pregnancyWeek = function(item){
		...
		var getPregnancyDetails = function(week){
			$.ajax({
				type: 'post',
		...
		var getBabyDetails = function(week){
			$.ajax({
				type: 'post',
