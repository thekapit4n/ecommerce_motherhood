...
<!--====================USP ====================-->
<div class="clearfix"></div>
<div class="col-lg-12 main_banner_margin" style="padding-left: 0px; padding-right: 0px;"><a href="../../../events/motherhood-superkids" target="_blank" rel="noopener"> <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/usp2.png" alt="" width="100%" /></a></div>
<div class="clearfix"></div>
<!--====================LUCKYDRAW ====================-->
<div class="clearfix"></div>
<div class="col-lg-12 main_banner_margin" style="padding-left: 0px; padding-right: 0px;"><a href="../../../events/motherhood-superkids" target="_blank" rel="noopener"> <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/new2.png" alt="" width="100%" /></a></div>
<div class="clearfix"></div>
<!--====================WEBINAR ====================-->
<div class="clearfix"></div>
...
<div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
	<div class="row mt-4">
		<div class="col-md-12 text-center">
			<h3 style="font-size: 24px; color: #4c4c4d;font-weight: 700;" class="title-form">Ready to be a Motherhood Super Kid?</h3>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2 div-email">
					<div class="form-floating">
					  <input type="email" class="form-control input-email" id="newEmailInput" name="newEmail" value="{{currentEmail}}" placeholder="email address" required>
			...
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control"  id="newFirstName" name="newFirstName" value="{{firstname}}" placeholder="First name" required>
					  <label for="newFirstName">First name</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control"  id="newLastName"  name="newLastName" value="{{lastname}}"  placeholder="Last name" required>
			...
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  ...
					  <label for="subscriber_question1">Mobile name</label>
					</div>
			...
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-12 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control full-address"  id="subscriber_question7" name="subscriber_question7" value="{{address1}}" placeholder="Full address" required>
					  <label for="subscriber_question7">Full address</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-md-3">
				<div class="col-md-4 my-2 my-md-1 px-2 div-postcode">
					<div class="form-floating">
					  <input type="text" class="form-control addr-postcode"  id="subscriber_question8" name="subscriber_question8" value="{{postcode}}" placeholder="Postcode" required size="10" required="required" onkeydown="javascript: return event.keyCode == 69 ? false : true">
					  <label for="subscriber_question8" >Postcode</label>
					</div>
					<small class="error-msg"></small>
				</div>
				<div class="col-md-4 my-2 my-md-1 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control addr-city"  id="subscriber_question9" name="subscriber_question9" value="{{city}}" placeholder="City" required size="10" required="required" onkeydown="javascript: return event.keyCode == 69 ? false : true">
					  <label for="subscriber_question9" >City</label>
					</div>
				</div>
				<div class="col-md-4 my-2 my-md-1 px-2">
					<div class="form-floating">
						<select class="form-select addr-state" id="subscriber_question10" name="subscriber_question10" aria-label="State" required="required">
							<option value="">State</option>
							<option  value="Johor" 		 stateselected316="">Johor</option>
							<option value="Kedah"  		 stateselected317="">Kedah</option>
							<option value="Kelantan" 	 stateselected318="">Kelantan</option>
							<option value="Kuala Lumpur" stateselected313="">Kuala Lumpur</option>
							<option value="Labuan" 		 stateselected314="">Labuan</option>
							<option value="Melaka" 		 stateselected319="">Melaka</option>
							<option value="Negeri Sembilan" stateselected320="">Negeri Sembilan</option>
							<option value="Pahang" stateselected321="">Pahang</option>
							<option value="Perak" stateselected322="">Perak</option>
							<option value="Perlis" stateselected323="">Perlis</option>
							<option value="Pulau Pinang" stateselected324="">Pulau Pinang</option>
							<option value="Putrajaya" stateselected315="">Putrajaya</option>
							<option value="Sabah" stateselected325="">Sabah</option>
							<option value="Sarawak" stateselected326="">Sarawak</option>
							<option value="Selangor" stateselected327="">Selangor</option>
							<option value="Terengganu" stateselected328="">Terengganu</option>
						 </select>
						<label for="subscriber_question10">State</label>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row" id="childDiv1">
		<div class="col-md-12">
			...
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_name1" id="subscriber_question11" name="subscriber_question11" value="" placeholder="child name" required="required">
					  <label for="subscriber_question11">Child name</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_mykid1" id="subscriber_question12" name="subscriber_question12" placeholder="mykid ic" required="required">
					  <label for="subscriber_question12">Mykid IC</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="date" class="form-control child-input child_dob1" id="subscriber_question13" name="subscriber_question13" value="" placeholder="DD/MM/YYYY" required="required">
					  <label for="subscriber_question13">Child DOB</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_contact1" id="subscriber_question14" name="subscriber_question14" placeholder="Child Contact (Optional)">
					  <label for="subscriber_question14">Child Contact (Optional)</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_gender1" id="subscriber_question15" name="subscriber_question15" aria-label="gender" required="required">
							<option value="">Please select gender</option>
							<option value="Male">Boy</option>
							<option value="Female">Girl</option>
						</select>
						<label for="subscriber_question15">Gender</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_milkbrand1" id="subscriber_question26" name="subscriber_question26" aria-label="milkbrand" required="required">
							<option value="">Current Milk Brand</option>
							{{option-kidmilk}}
						</select>
						<label for="subscriber_question15">Current Milk Brand</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-12 px-2 text-left">
					<button type="button" class="btn btn-primary btn-add-child" onclick="$('#childDiv2').show('slow');">+Add Child</button>
				</div>
			</div>
		</div>
	</div>
	<div id="childDiv2" class="row" style="display:none;">
		<div class="col-md-12">
			<p style="font-size: 1.6em; color: #4c4c4d; font-weight: bold; padding-top: 20px; line-height: 1; text-align: left;">Child #2</p>
			<hr style="border: 2px solid; margin-top: 2px;" />
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_name2" id="subscriber_question16" name="subscriber_question16" value="" placeholder="child name">
					  <label for="subscriber_question16">Child name</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_mykid2" id="subscriber_question17" name="subscriber_question17" placeholder="mykid ic">
					  <label for="subscriber_question17">Mykid IC</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="date" class="form-control child-input child_dob2" id="subscriber_question18" name="subscriber_question18" value="" placeholder="DD/MM/YYYY">
					  <label for="subscriber_question18">Child DOB</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_contact2" id="subscriber_question19" name="subscriber_question19" placeholder="Child Contact (Optional)">
					  <label for="subscriber_question19">Child Contact (Optional)</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_gender2" id="subscriber_question20" name="subscriber_question20" aria-label="gender">
							<option value="">Please select gender</option>
							<option value="Male">Boy</option>
							<option value="Female">Girl</option>
						</select>
						<label for="subscriber_question20">Gender</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_milkbrand2" id="subscriber_question27" name="subscriber_question27" aria-label="milkbrand">
							<option value="">Current Milk Brand</option>
							{{option-kidmilk}}
						</select>
						<label for="subscriber_question27">Current Milk Brand</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-12 px-2 text-left">
					<button type="button" class="btn btn-primary btn-add-child" onclick="$('#childDiv3').show('slow');">+Add Child</button>
				</div>
			</div>
		</div>
	</div>
	<div id="childDiv3" class="row" style="display:none;">
		<div class="col-md-12">
			<p style="font-size: 1.6em; color: #4c4c4d; font-weight: bold; padding-top: 20px; line-height: 1; text-align: left;">Child #3</p>
			<hr style="border: 2px solid; margin-top: 2px;" />
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_name3" id="subscriber_question21" name="subscriber_question21" value="" placeholder="child name">
					  <label for="subscriber_question21">Child name</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_mykid3" id="subscriber_question22" name="subscriber_question22" placeholder="mykid ic">
					  <label for="subscriber_question22">Mykid IC</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="date" class="form-control child-input child_dob3" id="subscriber_question23" name="subscriber_question23" value="" placeholder="DD/MM/YYYY">
					  <label for="subscriber_question23">Child DOB</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
					  <input type="text" class="form-control child-input child_contact3" id="subscriber_question24" name="subscriber_question24" placeholder="Child Contact (Optional)">
					  <label for="subscriber_question24">Child Contact (Optional)</label>
					</div>
				</div>
			</div>
			<div class="row mx-0 my-2 my-md-3">
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_gender3" id="subscriber_question25" name="subscriber_question25" aria-label="gender">
							<option value="">Please select gender</option>
							<option value="Male">Boy</option>
							<option value="Female">Girl</option>
						</select>
						<label for="subscriber_question25">Gender</label>
					</div>
				</div>
				<div class="col-md-6 px-2">
					<div class="form-floating">
						<select class="form-select child-input child_milkbrand3" id="subscriber_question28" name="subscriber_question28" aria-label="milkbrand">
							<option value="">Current Milk Brand</option>
							{{option-kidmilk}}
						</select>
						<label for="subscriber_question28">Current Milk Brand</label>
					</div>
				</div>
			</div>
		</div>
   ...
   <div class="row my-3">
		<div class="col-md-12 text-center">
			<button type="submit" name="submit" id="submitBtn" class="btn btn-default btn-submit-superkid"> SIGN UP NOW </button>
		</div>
   </div>
</div>
<!-- ================ Slider ========== -->
					...
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/sp1.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/sp1.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
									...
									<div class="ratings">
										<span class="star">
											<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
													 viewBox="0 0 46.93 44.88" style="enable-background:new 0 0 46.93 44.88;" xml:space="preserve">
												<style type="text/css">
													.st0{fill:#F7DC04;}
												</style>
												<path class="st0" d="M13.14,44.37c-2.83,1.46-6.13-0.93-5.61-4.08c0.44-2.66,0.87-5.16,1.35-7.65c0.51-2.63-0.08-4.61-2.1-6.46
													...
													C16.62,42.56,14.93,43.45,13.14,44.37z"/>
											</svg>
										</span>
										<span class="star">
											<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Rashidah.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Rashidah.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Liew-Soo-Hui.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Liew-Soo-Hui.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nur-Hidayah.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nur-Hidayah.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Mary-Joyce-Medina.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Mary-Joyce-Medina.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nurul-Asma.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nurul-Asma.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Cyrena-deosing2.png"  class="img-fluid customer-img-review">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Cyrena-deosing2.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
			...
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Pick-Yee-Chen.png">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Pick-Yee-Chen.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
		...
		<div class="row review-item">
			<div class="col-sm-12">
				<div class="card review-item-panel">
					<div class="row">
						<div class="col-md-3 col-12">
							<div class="div-img-review" style="padding-top:10px;">
								<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nik+Nor+Izyanty+Che+Mazlan.png">
									<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Superkids/review/Nik+Nor+Izyanty+Che+Mazlan.png"  class="img-fluid customer-img-review" >
								</a>
							</div>
						</div>
						<div class="col-md-9 col-12" style="padding-left:10px !important;">
	...
	<div class="multiple-img-slider" style="display:none;">
		<div class="product-container ">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/1.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/1.jpg" alt="testimonials_1" title="testimonials_1" />
				</a>
			</div>
		</div>
		<div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/2.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/2.jpg" alt="testimonials_2" title="testimonials_2" />
				</a>
			</div>
		</div>
		<div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/3.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/3.jpg" alt="testimonials_3" title="testimonials_3" />
				</a>
			</div>
		</div>
		<div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/4.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/4.jpg" alt="testimonials_4" title="testimonials_4"/>
				</a>
			</div>
		</div>
		<div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/5.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/5.jpg"  alt="testimonials_5" title="testimonials_5" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/6.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/6.jpg" alt="testimonials_6" title="testimonials_6" />
				</a>
			</div>
	   </div> 
	   <div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/7.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/7.jpg"  alt="testimonials_7" title="testimonials_7" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/8.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/8.jpg"  alt="testimonials_8" title="testimonials_8" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			 <div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/9.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/9.jpg"  alt="testimonials_9" title="testimonials_9" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			 <div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/10.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/10.jpg" data-src="" alt="testimonials_10" title="testimonials_10" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/11.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/11.jpg"  alt="testimonials_11" title="testimonials_11" itemprop="image" />
				</a>
			</div>
	   </div>
	   <div class="product-container">
			<div class="product-image-container">
				<a class="pop-out-img" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/12.jpg" >
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2020/November/Super+Kids/testimonials/12.jpg"  alt="testimonials_12" title="testimonials_12" />
				</a>
			</div>
	   </div>
	</div>
...
<div class="row my-3">
	<div class="col-md-12 text-center">
		<a href="https://www.instagram.com/explore/tags/motherhoodsuperkid/" class="btn btn-default button button-medium btn-ig" target="_blank" style="padding: 8px 40px; background-color: #ec3c65;" rel="noopener"><i class="fab fa-instagram"></i> &nbsp; See more on Instagram </a>
		<a href="https://www.facebook.com/hashtag/motherhoodsuperkid/?_rdc=1&amp;_rdr" class="btn btn-default button button-medium btn-fb" target="_blank" style="padding: 8px 40px; background-color: #4474b6;" rel="noopener"><i class="fab fa-facebook-square"></i> &nbsp; See more on Facebook </a>
	</div>
</div>
...
<div class="row my-2">
	<div class="row">
		<div class="col-md-12 text-left">
			 <p style="font-size: 2em; color: #97999b; font-weight: bold;">FAQs</p>
		</div>
	</div>
	<div class="row">
