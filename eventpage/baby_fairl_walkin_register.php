<style>
 ...
 <div class="step1">
    <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
       ...
       <div class="row">
          <div class="col-md-12">
             <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Babyfair/Dec2021/banner/BABYFAIR-DEC2021-banner.png" width="100%" />
             <h2 class="py-2">Which one are you now?</h2>
          </div>
       </div>
       <div class="row">
          <div class="col-12 col-md-6 px-2" style="padding-top: 10px;"><a href="#next" id="pregnant" value="pregnant" class="btn btn-primary step1btn">I'm Pregnant</a></div>
          <div class="col-12 col-md-6 px-2" style="padding-top: 10px;"><a href="#next" id="babyOut" value="babyOut" class="btn btn-primary step1btn">I'm a Parent &amp; Others</a></div>
          <!--
    ...
    <div class="row" style="padding-top: 50px; padding-bottom: 50px;">
       <div class="col-md-4 col-md-offset-3 col-lg-6 col-lg-offset-3 col-lg-6 col-xs-12 col-sm-12" style="text-align: left;">
          ...
          <div class="col-md-12 col-lg-12" style="text-align: center; padding-top: 20px;">
             <div style="padding: 20px 20px 10px 30px; margin-top: 10px; border: 1px solid rgba(0,0,0,.1);"><input type="checkbox" class="subscriber_question33" style="padding-top: 10px;" value="fB,insta" /> Facebook,Instagram</div>
             <div style="padding: 20px 20px 10px 30px; margin-top: 10px; border: 1px solid rgba(0,0,0,.1);"><input type="checkbox" class="subscriber_question33" style="padding-top: 10px;" value="newsletter,mail" /> E-mail</div>
             <div style="padding: 20px 20px 10px 30px; margin-top: 10px; border: 1px solid rgba(0,0,0,.1);"><input type="checkbox" class="subscriber_question33" style="padding-top: 10px;" value="sms" /> sms</div>
             <div style="padding: 20px 20px 10px 30px; margin-top: 10px; border: 1px solid rgba(0,0,0,.1);"><input type="checkbox" class="subscriber_question33" style="padding-top: 10px;" value="banner,bunting" /> Roadside Banner,bunting</div>
             <div style="margin-top: 10px;"><button id="step2Check" style="margin-top: 10px; font-weight: bold; display: block; width: 100%; background: #16a6ae; border: 1px solid rgba(0,0,0,.1); padding: 20px; font-size: 1.3em; color: white;"> Submit </button> <input type="hidden" id="subscriber_question3" name="subscriber_question3" /></div>
          </div>
       </div>
    </div>
 </div>
 <div class="step3" style="display: none;">
    <div class="row" style="padding-top: 10px; padding-bottom: 50px;">
       ...
       <div class="col-md-12 mobile-style-large" align="left">
          <div class="row">
             <div class="col-md-12 px-2 mb-2"><label for="newEmail" class="form-label required mobile-style-normal form-fair-label">Email</label> <input type="email" class="form-control" id="newEmail" name="newEmail" required="required" /> <small id="errorSpan" style="color: red;"></small></div>
          </div>
          <div class="row">
             <div class="col-md-6 px-2 mb-2"><label for="firstname" class="form-label required mobile-style-normal form-fair-label">First Name</label> <input id="newFirstName" name="newFirstName" type="text" class="form-control" required="required" /></div>
             <div class="col-md-6 px-2 mb-2"><label for="newLastName" class="form-label required mobile-style-normal form-fair-label">Last Name</label> <input id="newLastName" name="newLastName" type="text" class="form-control" required="required" /></div>
          </div>
          <div class="row">
             <div class="col-md-6 px-2 mb-2"><label for="subscriber_question13" class="form-label required mobile-style-normal form-fair-label">Your birthday</label> <input id="subscriber_question13" name="subscriber_question13" type="text" class="form-control" required="required" /></div>
          </div>
          <div class="row">
             <div class="col-md-12 px-2 mb-2">
                <label for="subscriber_question14" class="form-label mobile-style-normal form-fair-label">What brand of milk does mommy like or is currently consuming? Optional*</label>
                <select id="subscriber_question14" class="form-select" name="subscriber_question14">
          ...
          <div class="row">
             <div class="col-md-12 px-2 mb-2">
                <label for="subscriber_question15" class="form-label mobile-style-normal form-fair-label">What milk brand is your kid currently consuming? Optional*</label>
                <select id="subscriber_question15" name="subscriber_question15" class="form-select">
                   <option disabled="disabled" selected="selected" value="">Choose one</option>
          ...
          <div class="row">
             <div class="col-md-12 px-2 mb-2"><label for="subscriber_question1" class="form-label required mobile-style-normal form-fair-label">Contact Number</label> <input class="form-control" id="subscriber_question1" name="subscriber_question1" required="required" type="number" title="xxx xxxxx" placeholder="XXX XXXXXXX" onkeydown="javascript: return event.keyCode == 69 ? false : true" pattern=".{10,}" /> <small class="mobile-style-small" style="color: #959595;">*For singapore number,+5 for prefix (+65). e.g. +5 XXXX XXXX.</small><br /> <small style="color: red; display: none;" id="phoneNoError">Invalid phone number format. Correct format(XXX XXXXXXXX), e.g. 0123334444 / 0198887777. <br /></small> <small style="color: red; display: none;" id="phoneNoPrefixError">Invalid phone number prefix. Correct Prefix (010,011,012,013,014,015,016,017,018,019). <br /></small> <small style="color: red; display: none;" id="phoneNoErrorSg">Invalid Singapore phone number format. Correct Format(5 XXXX XXXX), e.g. 5 66667777.<br /></small></div>
          </div>
          <div class="row" id="newUserSpan">
             <div class="col-md-6 px-2 mb-2"><label for="newPassword" class="form-label required mobile-style-normal form-fair-label">New Password</label> <input id="newPassword" name="newPassword" type="password" class="form-control" /> <small style="color: #959595;" class="mobile-style-small">(*More than 6 Characters )</small></div>
             <div class="col-md-6 px-2 mb-2"><label for="confirmPassword" class="form-label required mobile-style-normal form-fair-label">Confirm Password</label> <input id="confirmPassword" name="confirmPassword" type="password" class="form-control" /></div>
          </div>
          <!--
             petrina request 28/3/2021.
             --->
          <div class="row">
             <div class="col-md-12 px-2 mb-2"><label for="subscriber_question7" class="form-label mobile-style-normal form-fair-label">Address (optional)</label> <input type="text" class="form-control" name="subscriber_question7" /></div>
          </div>
          <div class="row">
             <div class="col-md-4 px-2 mb-2"><label for="subscriber_question8" class="form-label required mobile-style-normal form-fair-label">Postcode</label> <input type="text" class="form-control addr-postcode" name="subscriber_question8" id="subscriber_question8" required="required" onkeydown="javascript: return event.keyCode == 69 ? false : true" /></div>
             <div class="col-md-4 px-2 mb-2"><label for="subscriber_question9" class="form-label required mobile-style-normal form-fair-label">City</label> <input type="text" class="form-control addr-city" name="subscriber_question9" id="subscriber_question9" required="required" /></div>
          ...
          <div class="row">
             <div class="col-md-12"><button type="submit" name="submit" class="btn btn-default button button-medium  pull-right " id="submitButton"> <span>Submit Information<i class="icon-chevron-right right"></i></span> </button></div>
          </div>
