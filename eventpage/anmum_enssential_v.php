...
<div class="container">
   <div class="row mb-2" style="margin-left: 0px; margin-right: 0px; margin-bottom: -15px !important;">
      <div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px;">
		...
		<div class="alert alert-warning" role="alert">
			This sample redemption is only open for first-time Anmum Essential users
		</div>
	  </div>
   </div>
   <div style="background-color: #f7f7f7; padding-top: 40px;">
      	<div class="row mb-2 px-md-5 mx-md-5">
         	<div class="col-md-6 px-2">
				...
				<div class="input-group">
					...
					<input type="hidden" class="year-1" value="{{ageyear1}}" /> 
					<input type="hidden" class="year-3" value="{{ageyear3}}" /> 
		...
		<div class="row mb-2 mb-2 px-md-5 mx-md-5">
			<div class="col-md-6 px-2">
				<label for="fulladdress" class="form-label required">Child's Date of Birth</label> 
				<input type="text" id="dobChild" name="subscriber_question10" class="form-control" placeholder="Child's DOB" required="required" /> 
				<small><i class="fas fa-info-circle"></i> Applicable for children 1 to 3 years old only</small>
			</div>
		 <div class="col-md-6 px-2">
            <label class="form-label required">What milk brand is your kid currently consuming?</label>
            <select class="form-select selection-kidmilk" id="kid-milk-brand" name="subscriber_question11" aria-label="" style="height: 37px;" required>
               ...
               <option value="Morinaga Chil-Kid">Morinaga Chil-Kid</option>
               <option value="Pediasure">Pediasure</option>
               <option value="S26 Progress">S26 Progress</option>
               <option value="S26 Progress Gold">S26 Progress Gold</option>
             ...
             <div class="col-md-12 px-2">
                 <div class="form-check">
                     ...
                     <label class="form-check-label noUniform px-3" for="tnccheckbox"> 
                     	By submitting this form, I hereby agree to the Terms and Conditions and consent to the collection and processing of my personal data by 
						Fonterra Brands (Malaysia) Berhad in accordance with the Privacy Policy.
						I hereby consent to receive Anmum™ ESSENTIAL Malaysia information via mail/sms/phone/email and Free sample*. Collected data can also be used for customer service purpose.
                     </label>
                 </div>
             </div>
         </div>
         ...
         <div class="row my-4 px-md-5 mx-md-5">
            <div class="col-md-12 px-2 py-4" style="color: white;">
               ...
               <ol style="list-style: decimal; padding-left: 20px;" start="1">
                  <li class="text-left tnc_li">This redemption is only valid for parents with children aged between 1 to 3 years old.</li>
...
<p>
   ...
   <script>// <![CDATA[
	...
	$(function(){
		...
		var maxAge = $('body').find('.year-1').val();
		var minAge =  "01/01/" + (currentYear-3);
