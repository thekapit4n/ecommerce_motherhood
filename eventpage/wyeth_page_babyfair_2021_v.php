...
<div class="row row-question" style="padding-top: 20px; padding-bottom: 10px;">
               ...
               <div class="row">
                  <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
                     <div class="row row-form">
                        ...
                        <div class="col-md-6 text-left question-welcomekit div-password" style="display: {{display-password-input}};"><label>Create Account Password</label> <input type="password" id="newPassword" name="newPassword" class="form-control input-info {{greybg-readonly-class}}" minlength="6/" placeholder="Password" data-input-required="" data-input-disabled="" /> <small>Please assign a password for your Motherhood account.</small> <small class="error-msg"></small></div>
                     </div>
                     <div class="row row-form">
   ...
   <p>
      <script>// <![CDATA[
		alert("currently this page is under maintainance, all the submition will consider as testing data and will be removed later. 14/12/2021")
													...
													if(result.status == true)
                                 					{
														...
														if(result.status_code == 'exist_customer_event')
                                 						{
         													emailSelector.closest('div').find(errorSelector).html(icon + " you have registered this event");
