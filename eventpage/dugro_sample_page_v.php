...
<div class="container">
   <div class="row mb-2">
      <div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px;"><img class="background" id="background" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/July/Dumex+Dugro/main-banner.jpeg" width="100%" /></div>
   ...
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="firstname" class="form-label required">Nama pertama</label> <input type="text" class="form-control fname" id="firstname" name="newFirstName" required="" /> <small class="error-msg"></small></div>
      <div class="col-md-6 px-2"><label for="lastname" class="form-label required">Nama keluarga</label> <input type="text" class="form-control lname" id="lastname" name="newLastName" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="mobileno" class="form-label required">No. telefon</label> <input type="text" class="form-control mobile-no" id="mobileno" name="subscriber_question1" required="" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2 row-password" style="display: {{row-password-display}};">
      <div class="col-md-12 px-2">
         <p class="lead my-1 new-account-text" style="font-weight: 600;"><i class="fas fa-info-circle text-info"></i> kata laluan adalah untuk sistem motherhood membuat akaun anda secara automatik.</p>
      </div>
   </div>
   <div class="row mb-2 row-password" style="display: {{row-password-display}};">
      <div class="col-md-6 px-2"><label for="newpassword" class="form-label required">Kata laluan</label> <input type="password" class="form-control inputpassword" id="newpassword" name="newPassword" /> <small class="error-msg"></small></div>
      <div class="col-md-6 px-2 div-confirm-password"><label for="confirmpassword" class="form-label required">Pengesahan kata laluan</label> <input type="password" class="form-control inputconfirmpassword" id="confirmpassword" name="confirmPassword" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
      <div class="col-md-12 px-2">
   ...
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="childname" class="form-label required">Nama si manja</label> <input type="text" class="form-control childname" id="childname" name="subscriber_question8" required="" /> <small class="error-msg"></small></div>
      <div class="col-md-6 px-2"><label for="childdob" class="form-label required">Tarikh lahir si manja</label> <input type="date" class="form-control childodb" id="childdob" name="subscriber_question2" required="" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
   ...
   <div class="row mb-2">
      <div class="col-md-12 px-2"><label for="address" class="form-label required">Alamat 1</label> <input type="text" class="form-control input-addr" id="address" name="subscriber_question3" required="" placeholder="Nombor rumah &amp; Jalan" /> <small class="error-msg"></small></div>
   </div>
   <div class="row mb-2">
   ...
   <div class="row mb-2">
      <div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode"><label for="postcode-address" class="form-label required">Poskod</label> <input type="text" class="form-control addr-postcode" id="postcode-address" name="subscriber_question4" required="" /> <small class="error-msg"></small></div>
      <div class="col-md-4 px-2 mb-3 mb-md-1"><label for="city-address" class="form-label required">Bandar</label> <input type="text" class="form-control addr-city" id="city-address" name="subscriber_question5" required="" /> <small class="error-msg"></small></div>
   ...
   <div class="row mb-2">
      <div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode"><label for="postcode-country" class="form-label required">Negara</label> <input type="text" class="form-control" id="postcode-country" name="subscriber_question13" required="" readonly="readonly" value="Malaysia" style="background-color: white;" /> <small class="error-msg"></small></div>
   </div>
   <div class="row my-4">
      <div class="col-md-12 px-2">
         <p  style="color: black;font-weight:700">**Untuk kanak-kanak berumur 1 tahun hingga 3 tahun yang minum susu tepung untuk kanak-kanak. Satu pek sampel terhad kepada seorang kanak-kanak sahaja. Stok adalah terhad. Penghantaran sampel susu formula Dugro akan mengambil masa selama 10-14 hari waktu bekerja.</p>
      </div>
   </div>
   <div class="row my-4">
      <div class="col-md-12 px-2">
         <div class="form-check"><input class="form-check-input noUniform" type="checkbox" value="yes" id="tnccheckbox" name="subscriber_question12" required="" /> <label class="form-check-label noUniform px-3" for="tnccheckbox"> Dengan memberikan maklumat peribadi saya, saya telah menyatakan dan menjamin bahawa saya bersetuju dengan Terma dan Syarat serta mengizinkan Danone Specialized Nutrition (Malaysia) Sdn Bhd memproses maklumat peribadi saya mengikut cara yang dinyatakan dalam Polisi Privasi. <br /> Dengan ini saya mengizin dan membenarkan untuk menerima maklumat Dumex Dugro melalui surat / sms / telefon / e-mel dan sampel percuma*. Data yang dikumpulkan juga dapat digunakan untuk tujuan perkhidmatan pelanggan. </label></div>
      </div>
   </div>
   <div class="row my-4">
      		...
      		var verifyMobileRegister = function(){
            	...
            	var validateChildDob = function(){
            		...
            		else
            		{
            			...
            			if(typeof arrDate[0] !== undefined && arrDate[0] !== null)
            			{
            				var dobYear = parseInt(arrDate[0]);
