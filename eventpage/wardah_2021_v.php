...
<div class="container">
   <div class="row mb-2" style="margin-left: 0px; margin-right: 0px; margin-bottom: -15px !important;">
      <div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px;"><img class="background" id="background" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/October/Wardah/main-banner.png" width="100%" /></div>
   </div>
   <div class="row my-4">
      <div class="col-lg-12 col-md-12 text-center">
         <h1>One more step to get your FREE WARDAH BOOSTER ESSENCE SAMPLE!</h1>
         <h1>Fill out the form below and GET IT NOW!</h1>
      </div>
   </div>
   <div style="background-color: #f7f7f7; padding-top: 40px;">
      ...
      <div class="row mb-2 px-md-5 mx-md-5">
         ...
         <div class="col-md-6 px-2">
            ...
            <div class="row row-other-skin-brand" style="margin-left: 0px; margin-right: 0px; display: none;">
               <div class="pt-2"><input type="text" class="form-control other-skin-brand" name="subscriber_question15" /></div>
            </div>
            <small class="error-msg"></small>
         </div>
      </div>
      ...
      <div class="row mb-2 px-md-5 mx-md-5">
         <div class="col-md-12 px-2"><label for="address" class="form-label required">Full address</label> <input type="text" class="form-control input-addr" id="address" name="subscriber_question3" required="required" placeholder="" /> <small class="error-msg"></small></div>
      </div>
      <div class="row mb-2 px-md-5 mx-md-5">
         <div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode"><label for="postcode-address" class="form-label required">Postcode</label> <input type="text" class="form-control addr-postcode" id="postcode-address" name="subscriber_question4" required="required" /> <small class="error-msg"></small></div>
         <div class="col-md-4 px-2 mb-3 mb-md-1"><label for="city-address" class="form-label required">City</label> <input type="text" class="form-control addr-city" id="city-address" name="subscriber_question5" required="required" /> <small class="error-msg"></small></div>
      ...
      <div class="row mb-2 px-md-5 mx-md-5">
         <div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode"><label for="postcode-country" class="form-label required">Country</label> <input type="text" class="form-control" id="postcode-country" name="subscriber_question8" required="" readonly="readonly" value="Malaysia" style="background-color: white;" /> <small class="error-msg"></small></div>
      </div>
      <div class="row my-4 px-md-5 mx-md-5">
         <div class="col-md-12 px-2">
            <div class="form-check"><input class="form-check-input noUniform" type="checkbox" value="yes" id="tnccheckbox" name="subscriber_question17" required="" /> <label class="form-check-label noUniform px-3" for="tnccheckbox"> TERMS AND CONDITIONS </label></div>
         </div>
      </div>
      <div class="row my-4 px-md-5 mx-md-5">
   ...
   <script>// <![CDATA[
      ...
      $(function(){
      	...
      	$('body').on('click', '.btn-submit-display', function(){
			...
			else if(emailInputStatus = 'exist_customer_motherhood_password_empty'){
				console.log("ok exist customer");
			}
      		else
      		{
      	...
      	$('body').on('change', '#skincarebrand', function(){
      		...
      		if(brandname == 'Other brands')
      		{
      			...
      			$('body').find('.other-skin-brand').attr('required', true);
      			$('body').find('.row-other-skin-brand').show('fast');
      		}
      		else
      		{
      			$('body').find('.other-skin-brand').val('');
      			$('body').find('.other-skin-brand').attr('required', false);
