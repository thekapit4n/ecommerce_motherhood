	...
	<div class="container">
		<div class="row mb-2">
			<div class="col-md-12 px-2 text-center">
				<h2>Apta Advantage Pregnant Moms</h2>
			</div>
		</div>
		<div class="row mb-2">
		...
		<div class="row mb-2">
			<div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode">
				...
				<input type="text" class="form-control" id="postcode-country" name="subscriber_question13" required readonly value="Malaysia" style="background-color:white;">
				<small class="error-msg"></small>
			</div>
		</div>
		<div class="row my-4">
			<div class="col-md-12 px-2">
				<div class="form-check">
					...
					<label class="form-check-label noUniform px-3" for="tnccheckbox">
						By submitting this form, I hereby agree to the Terms and Conditions and consent to the collection and processing of my personal data by Danone Specialized Nutrition (Malaysia) Sdn. Bhd. in accordance with the Privacy Policy.
						<br/>
						I hereby consent to receive AptaAdvantage information via mail/sms/phone/email and Free sample*. Collected data can also be used for customer service purpose.
					</label>
				</div>
			</div>
		</div>
