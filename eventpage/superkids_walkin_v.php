...
<!-- 
   ...
   -->
	<div class="row mb-4">
		<div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px; margin-bottom: 0;">
			<img src="https://via.placeholder.com/1170x481.png?text=bannerhere" width="100%" />
		</div>
	</div>
	<div class="row mb-2">
   ...
   <div class="row mb-2 row-password" style="display:{{row-password-display}}">
	...
	<div class="row my-2">
		<div class="col-md-12 px-2">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input noUniform option-other-milkbrand" type="checkbox" value="Aptaclub" id="option-milk-a">
				<label class="form-check-label noUniform px-3 py-1" for="option-milk-a" style="font-weight:400;">
				Aptaclub
				</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input noUniform option-other-milkbrand" type="checkbox" value="Anmum Essential Gold" id="option-milk-b">
				<label class="form-check-label noUniform px-3 py-1" for="option-milk-b" style="font-weight:400;">
					Anmum Essential Gold
				</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input noUniform option-other-milkbrand" type="checkbox" value="Dugro" id="option-milk-c">
				<label class="form-check-label noUniform px-3 py-1" for="option-milk-c" style="font-weight:400;">
					Dugro
				</label>
			</div>
	...
	<div class="row mb-2">
		...
		<input type="text" class="form-control input-addr" id="address" name="subscriber_question4" required="" placeholder="House number & Jalan"/> 
		<small class="error-msg"></small></div>
	</div>
	<div class="row mb-2">
		<div class="col-md-12 px-2">
			<label for="address2" class="form-label">Address 2</label>
			<input type="text" class="form-control input-addr2" id="address2" name="subscriber_question5" placeholder="Taman & Seksyen">
			<small class="error-msg"></small>
		</div>
	</div>
	<div class="row mb-2">
		<div class="col-md-4 px-2 mb-3 mb-md-1 div-postcode">
			...
			<input type="text" class="form-control addr-postcode" id="postcode-address" name="subscriber_question7" required>
			<small class="error-msg"></small>
		</div>
		<div class="col-md-4 px-2 mb-3 mb-md-1">
			<label for="city-address" class="form-label required">City</label>
			<input type="text" class="form-control addr-city" id="city-address" name="subscriber_question8" required>
			<small class="error-msg"></small>
		</div>
		<div class="col-md-4 px-2 mb-3 mb-md-1">
	...
	<div class="div-child-section-info">
		<div class="div-child-questions">
			<div class="row mb-2">
				<div class="d-flex ">
					<div class="me-auto p-2 bd-highlight"> <font style="font-weight: 600;font-size: 18px;" class="num-child-title">Child #1</font></div>
		   ...
		   <div class="row mb-2">
				<div class="col-md-6 px-2 div-question">
					<label for="" class="form-label required">Child name</label>
					<input type="text" class="form-control child-name-input" name="" /> 
					<small class="error-msg"></small>
				</div>
				<div class="col-md-6 px-2 div-question">
					<label for="" class="form-label required">Mykids IC</label>
					<input type="text" class="form-control child-ic-input" name="" /> 
					<small class="error-msg"></small>
				</div>
			</div>  
			<div class="row mb-2">
				<div class="col-md-6 px-2 div-question">
					<label for="" class="form-label required">Child DOB</label>
					<input type="date" class="form-control child-dob child-dob-input"  name=""  style="min-width:100%;"> 
					<small class="error-msg"></small>
				</div>
				<div class="col-md-6 px-2 div-question">
			...
			<div class="row mb-2">
				...
				<div class="col-md-6 px-2 div-question div-use-brand-question">
					...
					<div class="input-group mb-1" >
						<input type="number" class="form-control brand-use-input brand-year-use" placeholder="years" aria-label="years" /> 
						<span class="input-group-text">Years</span> 
						<input type="number" class="form-control brand-use-input brand-month-use" placeholder="months" aria-label="bulan" name="" /> 
						<span class="input-group-text">Bulan</span>
					 </div>
					 <input type="hidden" class="form-control duration-uses child-brand-uses-input" name="" /> 
					<small>Duration of consuming the milk brand. E.g. 1 Year 10 Months</small>
					<br/>
					<small class="error-msg brand-usage-message"></small>
				</div>
			</div> 
	   </div>
	</div>
	...
	<div class="row my-4">
		<div class="col-md-12 px-2">
			<div class="form-check">
				<input class="form-check-input noUniform" type="checkbox" value="yes" id="tnccheckbox" name="subscriber_question11" required>
