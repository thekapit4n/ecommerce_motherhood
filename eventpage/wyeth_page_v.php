               ...
               <div class="row">
                  <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
                     ...
                     <div class="row row-form display-edd-milk {{div-class-display-edd-milk}}">
                        <div class="col-md-6 text-left question-welcomekit ">
							<label>Estimate Date of Delivery (EDD)</label> <input type="text" class="form-control input-info background-grey-readonly display-input-edd" value="{{pre-define-edd}}" readonly="readonly" /></div>
                        <div class="col-md-6 text-left question-welcomekit">
							<label>Maternal Milk Brand</label> 
							<input type="text" class="form-control input-info background-grey-readonly display-input-milkbrand" value="{{pre-define-displaymilkbrad}}" readonly="readonly" /></div>
                     </div>
                     <!--===== end =====--->
                     ...
                     <div class="row row-form">
                        <div class="col-md-4 text-left question-welcomekit">
							...
							<input type="text" name="subscriber_question4" id="postcode-address" class="form-control input-info addr-postcode {{greybg-readonly-class}} " required="required" placeholder="Postcode" autocomplete="off" value="{{pre-define-postcode}}" data-input-disabled="" /> <small class="error-msg"></small></div>
                        <div class="col-md-4 text-left question-welcomekit">
							<label>City</label> 
								<input name="subscriber_question5" id="city-address" type="text" size="60" required="required" placeholder="City" class="form-control input-info addr-city {{greybg-readonly-class}}" autocomplete="off" value="{{pre-define-city}}" data-input-disabled="" /> <small class="error-msg"></small></div>
									...
									<tbody>
										<tr>
											<td style="font-weight: bold; vertical-align: top; padding-right:10px">
												<input id="checked-tnc-nestle" name="subscriber_question12" value="agree" required="required" type="checkbox" style="display: inline-block;"/>
										...
										<tr>
											<td style="font-weight: bold; vertical-align: top; padding-right:10px">
												<input id="checked-tnc-mmy" name="subscriber_question13" value="agree" required="required" type="checkbox" style="display: inline-block;"/>
										...
										<tr>
											<td style="font-weight: bold; vertical-align: top; padding-right:10px">
												<input name="subscriber_question14" id="receive-news" value="agree"  type="checkbox" style="display: inline-block;"/>
