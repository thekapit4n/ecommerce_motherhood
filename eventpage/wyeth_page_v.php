...
<!-- 
   ...
   -->
<div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px; margin-bottom: 0;"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/May/Wyeth+Nutrition/main-banner.png" width="100%" /></div>
<div class="row row-question" style="padding-top: 20px; padding-bottom: 10px;">
      ...
      <div class="panel panel-default">
         ...
         <div id="infoform" class="panel-collapse collapse in">
            <div class="panel-body">
               <div class="row">
                  <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
                     <div class="row row-form">
                        <div class="col-md-6 text-left question-welcomekit"><label>Email</label> <input type="email" id="emailNew" name="newEmail" class="form-control input-info {{greybg-readonly-email-class}}" placeholder="Email" required="required" style="background-color: white;" value="{{pre-define-email}}" data-input-email-disabled="" /> <input type="hidden" id="scrollingInput" class="form-control" value="{{pre-scrolling-val}}" /> <input type="hidden" id="subscribe-id" class="form-control" value="{{pre-subscribe-id}}" /> <input type="hidden" id="user-id" class="form-control" value="{{pre-user-id}}" /> <input type="hidden" id="user-login" class="form-control" value="{{pre-user-login}}" /> <input type="hidden" id="email_checked_input" value="{{pre-define-emailcheckinpt}}" /> <input type="hidden" id="edd_checked_input" value="{{pre-define-eddcheckinpt}}" /> <input type="hidden" class="dummycart" value="{{dummycartid}}" /> <small class="error-msg"></small></div>
                        <div class="col-md-6 text-left question-welcomekit div-password" style="display: {{display-password-input}};"><label>Password</label> <input type="password" id="newPassword" name="newPassword" class="form-control input-info {{greybg-readonly-class}}" minlength="6/" placeholder="Password" data-input-required="" data-input-disabled="" /> <small class="error-msg"></small></div>
                     </div>
                     <div class="row row-form">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <p style="font-size: 13px; line-height: 23px; margin-bottom: 12px; text-align: left; margin-top: 25px;">By participating in this campaign, I have read, understood and agree to the campaign&rsquo;s <span style="text-decoration: none; color: #0f97f9;" class="tncbtn">Terms and Conditions</span>. I further agree to be registered as a member of Wyeth Nutrition ParenTeam Club and to the processing of your personal data in accordance with such club/membership terms (including to receive marketing and promotional information, product services and events for maternal milk, adult nutrition and growing up milk for children).</p>
                           <table style="margin: 15px 0px 15px 0px; font-weight: bold;">
                              <tbody>
                                 <tr>
                                    <td style="font-weight: bold; vertical-align: top; padding-right: 10px;"><input id="checked-tnc-nestle" name="subscriber_question12" value="agree" required="required" type="checkbox" style="display: inline-block;" /> <input type="hidden" class="tnc-nestle-checked" value="{{tnc-nestle}}" /></td>
                                    <td style="padding-left: 0px;">
                                       <p style="font-size: 13px; line-height: 15px; margin-bottom: 12px; padding-top: 0px;">By clicking Submit, I agree to the <a href="https://www.wyethnutrition.com.my/terms-and-conditions" target="_blank" rel="noopener">Terms and Conditions</a>, and <a href="https://www.wyethnutrition.com.my/privacy-notice" target="_blank" rel="noopener">Privacy Policy</a> of Wyeth Nutrition (Malaysia) Sdn Bhd.</p>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="font-weight: bold; vertical-align: top; padding-right: 10px;"><input id="checked-tnc-mmy" name="subscriber_question13" value="agree" required="required" type="checkbox" style="display: inline-block;" /> <input type="hidden" class="tnc-mmy-checked" value="{{tnc-mmy}}" /></td>
                                    <td style="padding-left: 0px;">
                                       <p style="font-size: 13px; line-height: 15px; margin-bottom: 12px; padding-top: 0px;">By clicking Submit, I agree to the <a href="../../../page/terms-of-service" target="_blank" rel="noopener">Terms and Conditions,</a> and <a href="../../../page/privacy-policy" target="_blank" rel="noopener">Privacy Policy</a> of Motherhood.com.my.</p>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="font-weight: bold; vertical-align: top; padding-right: 10px;"><input name="subscriber_question14" id="receive-news" value="agree" type="checkbox" style="display: inline-block;" /> <input type="hidden" class="news-promo-checked" value="{{news-promo}}" /></td>
                                    <td style="padding-left: 0px;">
                                       <p style="font-size: 13px; line-height: 15px; margin-bottom: 12px; padding-top: 0px;">Would you like to receive future marketing and promotional information about the Wyeth Nutrition ParenTeam Club &rsquo;s products, services and events in the future?</p>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
			   ...
			   <div class="row">
					<div class="col-md-12">
						<p style="font-size:13px;" class="text-left">IMPORTANT NOTICE: Breast-feeding. A well-balanced diet, both during pregnancy and after delivery, helps sustain an adequate supply of breastmilk. After delivery, breast-feeding provides the best nutrition and protection from illness for your baby. Exclusive breastfeeding is recommended during the first 6 months of life followed by the introduction of adequate nutritious complementary foods, along with sustained breastfeeding for up to two years of age and beyond. For advice on breast-feeding, consult your doctor or other health professionals.</p>
					</div>
			   </div>
            </div>
         </div>
   ...
   <div style="display: none;"><a id="tncpopupimg" href="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/April/New+Mom+Essentials/%E2%80%9CRedeem+Nestl%C3%A9+Mom+Sample%E2%80%9D+Campaign+-+Terms+%26+Conditions.png"> </a></div>
   <p>
      <script>// <![CDATA[
