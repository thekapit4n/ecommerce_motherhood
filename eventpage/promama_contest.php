...
<div class="container">
   <div class="row mb-2" style="margin-left: 0px; margin-right: 0px; margin-bottom: -15px !important;">
      <div class="col-lg-12 col-md-12" style="padding-left: 0px; padding-right: 0px;">
	  	<img class="background" id="background" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2022/March/Wyeth/Promama/main-banner-contest.png" width="100%" />
	  	<img class="background" id="background" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2022/March/Wyeth/Promama/how-to-join.png" width="100%" />
	  </div>
   </div>
   <div style="background-color: #f7f7f7; padding-top: 40px;">
		...
		<div class="row mb-2 mb-2 px-md-5 mx-md-5">
			<div class="col-md-6 px-2">
				<label for="fulladdress" class="form-label required">Date of Birth</label> 
				<input type="text" id="dobParent" name="subscriber_question10" class="form-control" placeholder="" required="required" /> 
			</div>
			<div class="col-md-6 px-2">
				<label for="fulladdress" class="form-label required">Estimated date of delivery (EDD)</label> 
				<input type="text" id="pregnantedd" name="subscriber_question12" class="form-control" placeholder="" required="required" /> 
			</div>
      </div>
	  <div class="row mb-2 mb-2 px-md-5 mx-md-5">
			<div class="col-md-6 px-2">
				<label for="fulladdress" class="form-label required">Facebook Name</label> 
				<input type="text" name="subscriber_question13" id="facebook-name" class="form-control" placeholder="" required="required" /> 
				
			</div>
		 <div class="col-md-6 px-2">
            <label class="form-label required">What maternal milk brand currently consuming?</label>
            <select class="form-select selection-maternalmilk" id="kid-maternal-brand" name="subscriber_question11" aria-label="" style="height: 37px;" required>
		...
		<div class="row mb-2 px-md-5 mx-md-5">
			<div class="col-md-12 px-2"><label for="address" class="form-label required">Full address</label> 
         ...
         <div class="row my-4 px-md-5 mx-md-5">
             <div class="col-md-12 px-2">
                 <div class="form-check">
                     <input class="form-check-input noUniform" type="checkbox" value="yes" id="tnccheckbox" name="subscriber_question9" required="" /> 
                     <label class="form-check-label noUniform px-3" for="tnccheckbox"> 
					 		By submitting this form, I hereby agree to the <a href="https://bit.ly/3BYQkNU" target="_blank">Terms and Conditions</a>. I have read, understood & agreed to the full Terms and Conditions, and give consent to the collection and processing of my personal data by Motherhood.com.my, Wyeth Nutrition (Malaysia) Sdn. Bhd. in accordance with the Privacy Policy. I hereby consent to receive related information through any communication channels.
                     </label>
                 </div>
             </div>
         </div>
...
<p>
   ...
   <script>// <![CDATA[
			...
			if(arryDate.length == 3)
			{
				if(isNaN(arryDate[0]) || isNaN(arryDate[1]) || isNaN(arryDate[2]))
				{
					Swal.fire({
						icon: 'error',
						title: 'Error',
						text: 'Please enter your Date of Birth in correct format',
					});
	...
	$(function(){
		...
		$('body').on('blur', '#dobParent', function(){
			validateDob();
		});
		...
		$('body').on('click', '.btn-submit-display', function(){
			...
			var dobParent = $('body').find('#dobParent').val();	
			var maternalmilkbrand = $('body').find('#kid-maternal-brand').val();	
			var fbname = $('body').find('#facebook-name').val();	
			...
			if(dobParent == '' || dobParent == undefined || dobParent == null)
			{
				Swal.fire({
					icon: 'error',
					title: 'Error',
			...
			var check_childDOb = validateDob();
			...
			if(maternalmilkbrand == '' || maternalmilkbrand == undefined || maternalmilkbrand == null)
			{
				Swal.fire({
					icon: 'error',
					title: 'Error',
			...
			if(fbname == '' || fbname == undefined || fbname == null)
			{
				Swal.fire({
					icon: 'error',
					title: 'Error',
					text: 'Please enter your facebook name',
				});
