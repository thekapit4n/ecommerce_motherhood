...
<div class="main-div-nemum">
      ...
      <div class="container" style="position: relative; text-align: center;">
         ...
         <div class="col-md-12" style="padding-right: 23px;">
            <div class="row" style="margin-top: 25px;">
               <div class="col-md-12">
                  <p class="question-font" style="font-size: 30px; font-weight: bold; line-height: 33px;">Meet Motherhood.com.my your new mom life support</p>
   ...
   <div class="row step2v1" style="display: none; background-size: cover; background-position: top center; background-repeat: no-repeat; padding-top: 20px; padding-bottom: 20px;">
      ...
      <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
      <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;"><button type="button" class="btn btn-default btn-step1 step2btnv1"> Next </button></div>
      <div class="clearfix"></div>
   ...
   <div class="row step2v2" style="display: none; padding-top: 20px; padding-bottom: 20px;">
      ...
      <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
      <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;"><button type="button" class="btn btn-default btn-step1 step2btn"> Next </button></div>
      <div class="clearfix"></div>
   ...
   <div class="row step3v2" style="display: none; padding-top: 20px; padding-bottom: 20px;">
      ...
      <div class="col-hidden-xs col-hidden-sm col-md-2 col-lg-2"></div>
      <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;"><button type="button" class="btn btn-default btn-step1 step3v2btn"> Next </button></div>
   </div>
   <!-- Step 3 -->
