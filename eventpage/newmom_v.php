...
<div class="row step1">
<div class="container" style="position: relative; text-align: center;"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/logo-nm.png" width="30%" />
...
<div class="col-md-3 col-xs-3">
<div class="benefit-div"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/b1.png" width="100%" alt="newmomcardandgiftcard" />
<p style="font-weight: bold; padding-top: 10px; padding-bottom: 0px; line-height: 1; min-height: 50px;" class="main-title-color benefit-title">Free New Mom Membership</p>
<p style="font-weight: normal; padding-top: 0; padding-bottom: 0px; line-height: 1; min-height: 10px;" class="tnc-word-color benefit-desc">RM20 Giftcard + 5% Discount</p>
</div>
</div>
<div class="col-md-3 col-xs-3">
<div class="benefit-div"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/b2.png" width="100%" alt="flashcard" />
...
<div class="col-md-3 col-xs-3">
<div class="benefit-div"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/b3.png" width="100%" alt="" />
		...
		if(checkemail != undefined && checkemail != '' && password != undefined && password != '')
		{
			$.ajax({
				...
				success	 : function(result){
					...
					{
						alert('You email already exist for motherhood.com.my, to sign up for program, kindly fill in the email and password of your motherhood account when register');
					}
				}
			});
		}
