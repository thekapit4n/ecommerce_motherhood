...
<div class="main-div-nemum">
   <div class="row step1">
      <div class="container" style="position: relative; text-align: center;">
         <img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Newmom/logo-nm.png" width="30%" />
   ...
   <div class="row step3v1" style="display: none; padding-top: 20px; padding-bottom: 20px;">
		...
		<div class="row">
			<div class="col-md-12 text-center" style="padding-top: 20px;">
				<button type="button" id="step3btn" class="btn btn-default btn-step1 step3btn"> Next </button>
		  </div>
		</div>
   </div>
   ...
   <div class="row step3" style="display: none; padding-top: 20px; padding-bottom: 20px;">
      <div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
        ...
        <div class="col-md-4 text-left question-welcomekit" style="padding-top: 0px;">
         ...
         <div class="clearfix"></div>
         <div class="col-md-4 text-left question-welcomekit"><label>Your Date of Birth</label> 
		 <input name="subscriber_question14" type="text" id="dobParent" required="required" placeholder="DOB" class="form-control dob-parent" /> <small class="error-msg"></small></div>
         <div class="clearfix"></div>
   ...
   <div class="row huggies-row" style="display: none; padding-top: 20px; padding-bottom: 20px;">
		<div class="col-md-10 col-md-offset-1" style="background: rgba(255, 255, 255, 0.8); background-size: cover; padding-top: 20px; padding-bottom: 20px; border-radius: 10px;">
			<p style="font-size: 3em; color: #005b9c; font-weight: bold; padding-top: 20px; padding-bottom: 20px; line-height: 1;">
				Redeem FREE Huggies Natural Soft Diaper Samples
			</p>
			<div class="container" style="position: relative; text-align: center;">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/Jan/Huggies/huggies-banner.png" width="100%" />
			</div>
			<div class="row">
			...
			<button type="button" class="btn btn-default btn-step1 btn-next-huggies" id="btn-next-huggies"> Next </button></div>
				...
				<div class="col-md-12">
					<div class="tnc-word-color" style="margin-top: 30px;">
						<div class="col-md-12" style="text-align: left;">
							...
							<p class="text-left" style="font-size: 1em; line-height: 1.2; padding: 10px 10px 0px 10px;">- I consent to the processing of my personal information in accordance with the <span style="text-decoration: underline;" class="tncbtn">privacy policy<span></p>
						</div>
					</div>
				</div>
			</div>
