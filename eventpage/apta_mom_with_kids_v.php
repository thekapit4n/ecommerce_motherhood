...
<div class="container">
   <div class="row mb-2">
      <div class="col-md-12 px-2 text-center">
         <h2>Apta Advantage Moms with Kids</h2>
      </div>
   </div>
   <div class="row mb-2">
   ...
   <div class="row mb-2">
	  ...
	  <input type="text" class="form-control fname" id="firstname" name="newFirstName" required=""/> <small class="error-msg"></small>
	  </div>
      <div class="col-md-6 px-2">
   ...
   <div class="row mb-2">
      ...
      <div class="col-md-6 px-2">
         <label for="current-milkbrand" class="form-label required">Current Milk Brand</label>
         <select class="form-select current-milkbrand" name="subscriber_question10" id="current-milkbrand" aria-label="" style="height: 37px;" required="">
            <option value="">Please select current milik</option>
            {{option-listmilk}}
         </select>
         <small class="error-msg"></small>
      </div>
   ...
   <div class="row mb-2">
      <div class="col-md-12 px-2">
         <p class="lead my-1" style="font-weight: 600;"><i class="fas fa-info-circle text-info"></i> Child/children aged between 1 to 6 years old.</p>
      </div>
   </div>
   <div class="row mb-2">
      <div class="col-md-6 px-2"><label for="childname" class="form-label required">Child name</label> <input type="text" class="form-control childname" id="childname" name="subscriber_question8" required="" /> <small class="error-msg"></small></div>
   ...
   <div class="row mb-2">
      <div class="col-md-12 px-2"><label for="address" class="form-label required">Address 1</label> <input type="text" class="form-control input-addr" id="address" name="subscriber_question3" required="" placeholder="House number & Jalan"/> <small class="error-msg"></small></div>
   	...
   	<div class="row mb-2">
		<div class="col-md-12 px-2">
			<label for="address2" class="form-label required">Address 2</label>
			<input type="text" class="form-control input-addr2" id="address2" name="subscriber_question11" placeholder="Taman & Seksyen" required>
			<small class="error-msg"></small>
		</div>
	</div>
   <div class="row mb-2">
