...
-->
	...
	<div class="container">
		...
		<div class="row mb-2">
			<div class="col-md-12 px-2">
				<p class="lead my-1" style="font-weight:600;">
				  <i class="fas fa-info-circle text-info"></i> Child/children aged between 1 to 6 years old.
				</p>
			</div>
		</div>
		...
		<div class="row mb-2">
			<div class="col-md-6 px-2">
				<label for="childname" class="form-label required">Child name</label>
			...
			<div class="col-md-6 px-2">
				...
				<input type="text" class="form-control childodb" id="childdob" name="subscriber_question2" required>
				<small class="error-msg"></small>
			</div>
		</div>
		<div class="row mb-2">
			<div class="col-md-12 px-2">
				...
				<input type="text" class="form-control input-addr" id="address" name="subscriber_question3" required>
				<small class="error-msg"></small>
			</div>
		</div>
		<div class="row mb-2">
