...
<div class="row edd-row">
   <p style="font-size: 3em; color: #606060; font-weight: bold; padding-top: 20px; padding-bottom: 20px; line-height: 1;">Welcome Gift &amp; Lucky Draw Of The Month</p>
   <div class="container" style="position: relative; text-align: center; margin-bottom: 30px;"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/September/eddsept.png" width="100%" alt="banner-edd" /></div>
   ...
   <div class="row">
      ...
      <div class="col-md-6 text-left question-welcomekit row-kidmilk" style="padding-left: 25px; padding-right: 25px; padding-bottom: 10px;">
         <label style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px;"> What milk brand is your kid currently consuming? </label>
      ...
      <div class="col-md-4 col-md-offset-4" style="padding-top: 20px;"><button type="submit" name="submit" id="btn-submit-form2" class="btn btn-default btn-step1 " disabled="disabled"> Submit </button></div>
      <input type="hidden" id="newEmail" name="newEmail" value="{{currentEmail}}"/>
      <input type="hidden" name="subscriber_question30" value="{{foreignkey}}" />
   </div>
   <p>
      <script>// <![CDATA[
