...
<div class="online-content">
				...
				<ul class="calendar-slider">
					<li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_jan.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">9th January 2021</p>
								<p class="desc-webinar">Tips on a smooth delivery</p>
								<p>SPEAKER : DR AZRAI</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					</li> 
					<li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_feb.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">13th February 2021</p>
								<p class="desc-webinar">Mental &amp; Emotional Preparation Becoming a New Parent</p>
								<p>SPEAKER : PAMILIA</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
				   ...
				   <li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_mar.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th March 2021</p>
								<p class="desc-webinar">Safe Exercising Tips from Trimester 1 Till Delivery</p>
								<p>SPEAKER : PAVITHRA</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
				   </li> <li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_apr.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th April 2021</p>
								<p class="desc-webinar">1st to 4th Trimester Diet Guide</p>
								<p>SPEAKER : LEE CHUN HSIEN</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_may.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th May 2021</p>
								<p class="desc-webinar">Tips on How to Bath Your Baby</p>
								<p>SPEAKER : LIM SIEW PEI</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_jun.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th June 2021</p>
								<p class="desc-webinar">Baby Sleep Tips</p>
								<p>SPEAKER : SARAH ONG</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_jul.png" width="100%" alt="january" />
							</div>	
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th July 2021</p>
								<p class="desc-webinar">What To Eat After Delivery, and What to Feed Your Baby, Recipes Included</p>
								<p>SPEAKER : LEE CHUN HSIEN</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_aug.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th August 2021</p>
								<p class="desc-webinar">Healthy Breastfeeding Tips</p>
								<p>SPEAKER : DR ZARINA</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_sep.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th January</p>
								<p class="desc-webinar">Infant CPR</p>
								<p>SPEAKER : DR SHAHRUL</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
						</div>
					  </div>
					  ...
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_oct.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th October 2021</p>
				   ...
				   <li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_nov.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th November 2021</p>
					...
					<li class="product-box item" style="min-width: 150px;">
					  <div class="reviewBox-calendar">
						<div class="speakerBox-calendar" >
							<div class="col-md-4">
								<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/webinarupcomingdates/2021_dec.png" width="100%" alt="january" />
							</div>
							<div class="col-md-8 div-web-desc">
								<p style="font-weight: normal;" class="date-webinar">20th December 2021</p>
								<p class="desc-webinar">Safe Exercising Tips from Trimester 1 Till Delivery</p>
								<p>SPEAKER : PAVITHRA</p>
								<a href="https://www.motherhood.com.my/events/zoom-live-registration-form" class="btn btn-default btn-view-event">VIEW EVENT</a>
							</div>
   ...
   <div id="slider_row" class="row-fluid">
		<div class="row div-row-pastwebinarpic">
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/drazrai.png" width="100%" alt="Pandemic" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/elpeni.png" width="100%" alt="Breastfeeding" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/jayde_nov14.png" width="100%" alt="Dietary Guide" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/lavinia_june20.png" width="100%" alt="Aches and Pain During Pregnancy" />
			</div>
		</div>
		<div class="row">
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/jayden_july04.png" width="100%" alt="Pregnancy Myths" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/jayden_nov28.png" width="100%" alt="Pregnancy Complication" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/sarah-ong.png" width="100%" alt="Baby's Nap" />
			</div>
			<div class="col-md-3 col-lg-3 col-xs-6">
				<img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/webinar/limsiewpei.png" width="100%" alt="Breastfeeding" />
			</div>
		</div>
      <div class="clearfix"></div>
      <!-- Video testimonial -->
...
<div class="offline-content row">
   <!-- Offline Banner -->
   <div class="col-md-12 col-lg-12 col-xs-12"><img src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/mainbanner_offlinenew.png" width="100%" alt="offlineBanner" /></div>
   ...
   <!--====================== CTA BUTTON ==========================-->
	<div class="row">
		<div class="col-lg-12">
			<div style="margin-top:16px; margin-bottom:16px;padding-left: 27px; padding-right: 27px;">
				<a href="../../../campaign-nurengroup/education/baby-learning/baby-enrichment-classes/parentcraft-class-limited-seats-available.html" target="_blank" rel="noopener"> 
					<img class="" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/gif/joinnowbutton.gif" width="100%" /> 
				</a>
			</div>
		</div>
	</div>
   ...
   <div class="col-md-12 col-lg-12 col-xs-12">
      ...
      <img class="love-image-small" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/love-03.png" style="width: 35px; margin-top: -40px;" alt="love" />
      <div class="clearfix"></div>
      <div class="col-lg-2 col-md-2 col-xs-4" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px; min-height: 120px;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/newdate/date/offlinedate_new-02.png" width="100%" /></div>
      <div class="col-lg-2 col-md-2 col-xs-4" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px; min-height: 120px;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/newdate/date/offlinedate_new-03.png" width="100%" /></div>
      <div class="col-lg-2 col-md-2 col-xs-4" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px; min-height: 120px;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/newdate/date/offlinedate_new-04.png" width="100%" /></div>
      <div class="col-lg-2 col-md-2 col-xs-4" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px; min-height: 120px;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/newdate/date/offlinedate_new-05.png" width="100%" /></div>
      <div class="col-lg-2 col-md-2 col-xs-4" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px; min-height: 120px;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/offline+class/newdate/date/offlinedate_new-06.png" width="100%" /></div>
...
">
      ...
      <!-- Offline Itinerary Background END -->
		<div class="col-lg-12" style="margin-bottom: 16px;">
			<a href="../../../campaign-nurengroup/education/baby-learning/baby-enrichment-classes/parentcraft-class-limited-seats-available.html" target="_blank" rel="noopener">
			<img class="" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/PARENTCRAFT+CLASS/2020/landing+page/online+class/gif/joinnowbutton.gif" width="100%" /></a>
		</div>
		<p>
			<!--================== TAGLINE =================-->
		</p>
