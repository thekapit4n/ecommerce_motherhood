...
<div class="div-homepage">
   ...
   <div class="row" style="margin-bottom: 20px;">
      ...
      <div class="col-md-6">
         ...
         <div style="border: 1px solid #4d4c4d;"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon1.png" alt="image holder" style="width: 100%;" /></div>
      </div>
   </div>
   <!--
      <div class="row" style="margin: 0 0; font-family: 'Quicksand', sans-serif; color: grey; text-align: center;">
