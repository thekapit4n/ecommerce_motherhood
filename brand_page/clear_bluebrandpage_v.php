...
<div class="row" style="padding-bottom: 10px;">
   <div class="col-md-12">
      ...
      <button class="cat WyethBrandPageCatBtn" data-value="profile" style="background: #b4b3b4;border: #b4b3b4;">Profile</button>
   </div>
</div>
<div class="div-homepage">
		...
		<div class="row" style="margin-bottom:20px;">
			<div class="col-md-6">
				<center>
					<h3 style="font-weight: bold;font-family: 'Quicksand', sans-serif;border: solid 1px #203764;background: #203764;color: #e1f1fc;	padding-top: 8px;padding-bottom: 8px;border-radius: 10px;">
						Mama cuba try
					</h3>
				</center>
				<div style="border: 1px solid #4d4c4d">
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon1.png" alt="mama cuba try" style="width:100%">
				</div>
			</div>
			<div class="col-md-6">
					<center>
				...
				<div style="border: 1px solid #4d4c4d">
					<img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon1.png" alt="image holder" style="width:100%">
				</div>
			</div>
		</div>
		  ...
		  <div class="slider_container">
			 <ul id="nestlekol_list_car">
				...
				<li class="product-box item" style="min-width: 178px;">
				   ...
				   <p class="parent-article-title-cb">Prepare To Say: Oh I Didn’t Know! 9 Conception & Fertility Myths Debunked</p>
				...
				<li class="product-box item" style="min-width: 178px;">
				   ...
				   <p class="parent-article-title-cb">How To Have That ‘Let’s Have A Baby’ Conversation With Your Husband Tactfully</p>
				...
				<li class="product-box item" style="min-width: 178px;">
				   ...
				   <p class="parent-article-title-cb">You’re Not Alone When Baby Making: Here’s How To Keep Hubby’s “Swimmers” Swimming</p>
            ...
            <li class="nbs-flexisel-item" style="width: 262.5px;">
               <div class="product-container">
                  <div class="left-block2">
                     <div class="product-image-container"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" data-src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" alt="testimonials_1" title="testimonials_1" itemprop="image" /></div>
                  </div>
               </div>
            </li>
            <li class="nbs-flexisel-item" style="width: 262.5px;">
               <div class="product-container">
                  <div class="left-block2">
                     <div class="product-image-container"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" data-src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" alt="testimonials_2" title="testimonials_2" itemprop="image" /></div>
                  </div>
               </div>
            </li>
            <li class="nbs-flexisel-item" style="width: 262.5px;">
               <div class="product-container">
                  <div class="left-block2">
                     <div class="product-image-container"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" data-src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" alt="testimonials_3" title="testimonials_3" itemprop="image" /></div>
                  </div>
               </div>
            </li>
            <li class="nbs-flexisel-item" style="width: 262.5px;">
               <div class="product-container">
                  <div class="left-block2">
                     <div class="product-image-container"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" data-src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" alt="testimonials_4" title="testimonials_4" itemprop="image" /></div>
                  </div>
               </div>
            </li>
            <li class="nbs-flexisel-item" style="width: 262.5px;">
               <div class="product-container">
                  <div class="left-block2">
                     <div class="product-image-container"><img class="img-responsive" src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" data-src="https://s3.amazonaws.com/motherhood.com.my/assets/images/uploads/2021/March/Clearblue/coming-soon.png" alt="testimonials_5" title="testimonials_5" itemprop="image" /></div>
                  </div>
               </div>
            </li>
         </ul>
...
<p>
   <script type="text/javascript">
		...
		$(document).ready(function(){
            ...
            $("div#quizQuestion1").hide();
            $("div#quizQuestion2").hide();
             
            $("#quiz").click(function(){
				$("div#quizQuestion1").show();
				$("div#quizQuestion2").hide();
            });
             
            $("#quiz2").click(function(){
				$("div#quizQuestion1").hide();
				$("div#quizQuestion2").show();
            });
            ...
            {         
				...
				for(var i = 1; i <= 45; i++) {
					...
					if (amountA > amountB && amountA > amountC){
						alert("PREGNANT: You’re probably pregnant. Congratulations on your new journey! Motherhood is going to look good on you. Just to be sure, don’t forget to take a pregnancy test with Clearblue Pregnancy Test to confirm this exciting news.");
					}
					else if (amountB > amountA && amountB > amountC){
						alert("NOT PREGNANT: Pregnant or not, just enjoy the wonderful time you have with your partner—you deserve it! In the meantime, give Clearblue Pregnancy Test a try if you’re still unsure.");
					}
					else if (amountC > amountA && amountC > amountB){
						alert("MAYBE: You may or may not be pregnant. Just to be on the safe side, you’d want to take a pregnancy test with Clearblue Pregnancy Test for a more accurate result.");
					}
					else if (amountA == amountB || amountB == amountC || amountA == amountC ){
						alert("MAYBE: You may or may not be pregnant. Just to be on the safe side, you’d want to take a pregnancy test with Clearblue Pregnancy Test for a more accurate result.");
					}
             ...
             $(".scrollQuiz").click(function(){
             $('html, body').animate({
                     scrollTop: $("#quizQuestion1").offset().top
                 }, 1000);
             });
             
             $(".scrollQuiz2").click(function(){
             $('html, body').animate({
                     scrollTop: $("#quizQuestion2").offset().top
                 }, 1000);
             });
             
             $(".hideQuestion").click(function(){
             $('html, body').animate({
                     scrollTop: $("#quizMain").offset().top
                 }, 1000);
             });
            
             
            $(".submitButtonStyle1").click(function(){
				submitButtonStyle(this);
            });
			...
			$('body').on('click', '.WyethBrandPageCatBtn', function(){
				var cat = $(this).data('value');
				$(".WyethBrandPageCatBtn").css("background","#b4b3b4");
				$(".WyethBrandPageCatBtn").css("border","#b4b3b4");
				$(this).css("background","#38a7ac");
				$(this).css("border","#38a7ac");
				if(cat == 'home'){
				   $('.div-homepage').removeClass('visuallyhidden');
				   $('.div-profile').addClass('visuallyhidden-cb'); 
				   // $('.div-profile').css('visibility', 'hidden'); 
				   $('.productss').hide();
				   $('.productsFullPage').addClass('visuallyhidden'); 
				   $(window).resize();
				   $("img").trigger("unveil");
				}else if(cat == 'profile'){
				   $('.div-homepage').addClass('visuallyhidden');
				   $('.div-profile').removeClass('visuallyhidden-cb');
				    // $('.div-profile').css('visibility', 'none'); 
