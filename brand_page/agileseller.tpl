		...
		{*Reviews End*}
			...
			<div id="seller-contact-form">
				...
				<div class="seller_contact_label">Start a Conversation with {if $seller_info->id_seller == 695}Nestle{else if $seller_info->id == 177}Nivea Baby{else}this seller{/if}</div>
					<form action="{$link->getModuleLink("enlineamixmod","enlineamessengercustomer",array(),true)|escape:'html':'UTF-8'}?newchat=1&sellerid={$seller_info->id_seller}&sellername={$seller_info->company|replace:"'":""}" method="post">
