...
?>
    ...
    <div class="social-sharing<?php echo isset( $social_style ) ? $social_style : ''; ?>" data-permalink="<?php the_permalink();?>">
        ...
        <a class="share-item share-facebook" rel="nofollow" href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&t=<?php the_title_attribute(); ?>" target="blank">
            <i class="icomoon-facebook"></i>
            <?php echo isset( $label_facebook ) ? $label_facebook : ''; ?>
        </a>

        <a class="share-item share-twitter" rel="nofollow" href="https://twitter.com/intent/tweet?original_referer=<?php the_permalink(); ?>&text=<?php echo urlencode(get_the_title($post->ID)); ?>&tw_p=tweetbutton&url=<?php the_permalink(); ?><?php echo isset( $twitter_user ) ? '&via='.$twitter_user : ''; ?>" target="_blank">
        ...
        ?>
        <a data-pin-custom="true" rel="nofollow" class="share-item share-pinterest" href="//pinterest.com/pin/create/button/?url=<?php the_permalink();?>&media=<?php echo esc_url( isset( $showpinimage ) ? $showpinimage : '' ); ?>&description=<?php the_title_attribute(); ?>" target="_blank">
