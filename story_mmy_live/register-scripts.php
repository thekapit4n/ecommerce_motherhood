...
wp_enqueue_style( 'boostrap.slider.css', get_template_directory_uri() . '/bootstrap.slider.css');
wp_enqueue_script( 'boostrap.slider.js', get_template_directory_uri() . '/js/bootstrap.slider.js');
